...
核热推进利用核裂变反应堆产生的热能加热轻质推进剂（液氢），使其达到远超化学燃烧的温度后从喷管高速喷出产生推力。由于能量来源与推进剂分离，核热推进可实现化学推进 2–4 倍的比冲，是深空载人探测的关键使能技术。

### 技术特征

核热推进的核心性能参数为比冲 $I_{sp}$，近似关系为 $v_e \propto \sqrt{T/M}$（$T$ 为排气温度，$M$ 为工质分子量）。固体堆芯方案比冲约 900 s（受材料熔点限制），液体堆芯方案可达 1,400–2,000 s（通过离心力约束液态燃料突破温度限制）。

### 实现方法

固体堆芯 NTP 技术成熟度较高，已通过 NERVA/ROVER 计划验证。液体堆芯方案利用高速旋转离心力将液态铀约束在堆腔壁面，液氢从中心通道注入直接接触换热，核心技术挑战在于液态燃料流体动力学稳定性和核材料流失控制。
...
核热推进在载人火星探测中具有变革性意义，可将地火转移时间从 6–9 个月缩短至 3–4 个月，显著降低航天员的辐射累积剂量和生理心理负担。在地月空间任务中，核热推进可为月球货物预置、小行星带探测等任务提供高效运输能力，是支撑深空探索战略的关键推进技术。
