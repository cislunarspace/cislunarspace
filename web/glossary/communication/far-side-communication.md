...
description: 通过地月L2晕轨道中继卫星实现月球背面与地球之间的直接通信。
...
twitter:
  ...
  description: 通过地月L2晕轨道中继卫星实现月球背面与地球之间的直接通信。
  image: /logo.png
permalink: /glossary/communication/far-side-communication/
---

# 月球背面通信（Far Side Communication）
