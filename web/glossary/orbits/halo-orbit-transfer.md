---
title: 晕轨道转移（Halo Orbit Transfer）
description: 从晕轨道出发，利用其不稳定流形实现到目标轨道转移的轨道机动方案。
keywords: 晕轨道转移, Halo Orbit Transfer, 轨道设计, 轨道转移, 周期轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 从晕轨道出发，利用其不稳定流形实现到目标轨道转移的轨道机动方案。
  image: /logo.png
permalink: /glossary/orbits/halo-orbit-transfer/
---

# 晕轨道转移（Halo Orbit Transfer）
...
从晕轨道出发，利用其不稳定流形实现到目标轨道转移的轨道机动方案。
