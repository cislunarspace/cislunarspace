---
title: 垂直周期轨道（Vertical Periodic Orbit）
description: Lissajous轨道的一种特例，仅在z方向有运动分量，x-y平面投影为一点。
keywords: 垂直周期轨道, Vertical Periodic Orbit, 轨道设计, 周期轨道, 晕轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: Lissajous轨道的一种特例，仅在z方向有运动分量，x-y平面投影为一点。
  image: /logo.png
permalink: /glossary/orbits/vertical-periodic-orbit/
---

# 垂直周期轨道（Vertical Periodic Orbit）
...
Lissajous轨道的一种特例，仅在z方向有运动分量，x-y平面投影为一点。

## 应用价值

垂直周期轨道是地月空间轨道设计中的核心概念，在任务规划阶段用于确定航天器的运动规律和轨道特性。在实际任务中，该轨道参数可用于计算转移 delta-V、飞行时间，以及与其他轨道的交汇条件，为轨道方案比选提供定量依据。
