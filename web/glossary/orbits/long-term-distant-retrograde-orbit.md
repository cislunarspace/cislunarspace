---
title: 长期远距离逆行轨道（Long Term Distant Retrograde Orbit）
description: 在太阳引力摄动下仍保持有界的月球远距离逆行轨道。「长期」指轨道在任务预定时间内不发散，但不再是严格的周期轨道，而是准周期的。能否保持有界取决于太阳初始相位角，即发射窗口。
keywords: 长期远距离逆行轨道, Long Term Distant Retrograde Orbit, 轨道设计, 轨道力学, 平动点, 轨道转移
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 在太阳引力摄动下仍保持有界的月球远距离逆行轨道。「长期」指轨道在任务预定时间内不发散，但不再是严格的周期轨道，而是准周期的。能否保持有界取决于太阳初始相位角，即发射窗口。
  image: /logo.png
permalink: /glossary/orbits/long-term-distant-retrograde-orbit/
---

# 长期远距离逆行轨道（Long Term Distant Retrograde Orbit）
...
在太阳引力摄动下仍保持有界的月球远距离逆行轨道。「长期」指轨道在任务预定时间内不发散，但不再是严格的周期轨道，而是准周期的。能否保持有界取决于太阳初始相位角，即发射窗口。
