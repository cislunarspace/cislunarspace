---
title: 标称路径（Nominal Path）
description: 航天器在标称轨道上运动的轨迹路径。
keywords: 标称路径, Nominal Path, 轨道设计, 轨道力学, 转移轨道, 周期轨道
author: 天疆说
date: 2026-07-31
...
wechatShare:
  ...
  image: /logo.png
og:
  title: 标称路径（Nominal Path）详解 | 术语定义
  description: 航天器在标称轨道上运动的轨迹路径。
  image: /logo.png
  type: article
twitter:
  ...
  description: 航天器在标称轨道上运动的轨迹路径。
  image: /logo.png
permalink: /glossary/orbits/nominal-path/
---
