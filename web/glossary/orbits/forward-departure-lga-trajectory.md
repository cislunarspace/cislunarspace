---
title: 前向发射LGA轨迹（Forward-departure LGA Trajectory）
description: 借力时刻航天器相对月球位置在第一或第四象限、近月点速度方向为逆行的LGA轨迹类型。
keywords: 前向发射LGA轨迹, Forward-departure LGA Trajectory, 轨道, 平动点, Halo轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 借力时刻航天器相对月球位置在第一或第四象限、近月点速度方向为逆行的LGA轨迹类型。
  image: /logo.png
permalink: /glossary/orbits/forward-departure-lga-trajectory/
---

# 前向发射LGA轨迹（Forward-departure LGA Trajectory）
...
借力时刻航天器相对月球位置在第一或第四象限、近月点速度方向为逆行的LGA轨迹类型。
