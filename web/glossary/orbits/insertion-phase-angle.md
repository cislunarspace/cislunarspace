...
description: 在旋转坐标系中，从y轴正方向到目标DRO位置向量的夹角，用于确定入轨点在DRO上的具体位置。
...
twitter:
  ...
  description: 在旋转坐标系中，从y轴正方向到目标DRO位置向量的夹角，用于确定入轨点在DRO上的具体位置。
  image: /logo.png
permalink: /glossary/orbits/insertion-phase-angle/
---
...
入轨相位角是地月空间轨道设计中的核心概念，在任务规划阶段用于确定航天器的运动规律和轨道特性。在实际任务中，该轨道参数可用于计算转移 delta-V、飞行时间，以及与其他轨道的交汇条件，为轨道方案比选提供定量依据。
