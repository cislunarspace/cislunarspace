---
title: 远端（Far Side）
description: 远距逆行轨道中远离地球的一侧。
keywords: 远端, Far Side, 轨道设计, 周期轨道, 晕轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 远距逆行轨道中远离地球的一侧。
  image: /logo.png
permalink: /glossary/orbits/far-side/
---
...
远端是地月空间轨道设计中的核心概念，在任务规划阶段用于确定航天器的运动规律和轨道特性。在实际任务中，该轨道参数可用于计算转移 delta-V、飞行时间，以及与其他轨道的交汇条件，为轨道方案比选提供定量依据。
