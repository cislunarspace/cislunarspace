---
title: 相对周期轨道（Relative Periodic Orbit）
description: 相对相空间中状态每经周期T返回初始值的轨道。
keywords: 相对周期轨道, Relative Periodic Orbit, , 轨道设计, 轨道力学, 地月转移, 周期轨道, 晕轨道
author: 天疆说
date: 2026-07-31
...
wechatShare:
  ...
  image: /logo.png
og:
  title: 相对周期轨道（Relative Periodic Orbit）详解 | 术语定义
  description: 相对相空间中状态每经周期T返回初始值的轨道。
  image: /logo.png
  type: article
twitter:
  ...
  description: 相对相空间中状态每经周期T返回初始值的轨道。
  image: /logo.png
permalink: /glossary/orbits/relative-periodic-orbit/
---
