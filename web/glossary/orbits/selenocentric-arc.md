---
title: 月心弧段（Selenocentric Arc）
description: 以月球为主吸引体的轨道转移段，使用月心modified equinoctial elements（MEE）进行传播。
keywords: 月心弧段, Selenocentric Arc, 轨道设计, 轨道转移, 周期轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 以月球为主吸引体的轨道转移段，使用月心modified equinoctial elements（MEE）进行传播。
  image: /logo.png
permalink: /glossary/orbits/selenocentric-arc/
---

# 月心弧段（Selenocentric Arc）
...
以月球为主吸引体的轨道转移段，使用月心modified equinoctial elements（MEE）进行传播。
