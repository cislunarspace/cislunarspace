---
title: DRO带（DRO Zone）
description: 长期远距离逆行轨道在任务寿命内主要集中活动的有界区域。由雅可比能量最大值和最小值对应的两条DRO所围成，是对扰动DRO可达范围的实用描述。
keywords: DRO带, DRO Zone, , 轨道设计, 轨道力学, 地月转移, 周期轨道, 晕轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 长期远距离逆行轨道在任务寿命内主要集中活动的有界区域。由雅可比能量最大值和最小值对应的两条DRO所围成，是对扰动DRO可达范围的实用描述。
  image: /logo.png
permalink: /glossary/orbits/dro-zone/
---
...
长期远距离逆行轨道在任务寿命内主要集中活动的有界区域。由雅可比能量最大值和最小值对应的两条DRO所围成，是对扰动DRO可达范围的实用描述。
