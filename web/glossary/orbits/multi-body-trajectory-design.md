---
title: 多体轨道设计（Multi-Body Trajectory Design）
description: 利用多天体引力相互作用设计航天器轨道的方法。
keywords: 多体轨道设计, Multi-Body Trajectory Design, 轨道设计, 周期轨道, 晕轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 利用多天体引力相互作用设计航天器轨道的方法。
  image: /logo.png
permalink: /glossary/orbits/multi-body-trajectory-design/
---

# 多体轨道设计（Multi-Body Trajectory Design）
...
利用多天体引力相互作用设计航天器轨道的方法。

## 应用价值

多体轨道设计是地月空间轨道设计中的核心概念，在任务规划阶段用于确定航天器的运动规律和轨道特性。在实际任务中，该轨道参数可用于计算转移 delta-V、飞行时间，以及与其他轨道的交汇条件，为轨道方案比选提供定量依据。
