---
title: 站间邻域（Inter-Orbit Neighborhood）
description: 在不同轨道但共振比相同且太阳相位角相近的设施之间定义的邻域，用于跨轨道的设施替换。
keywords: 站间邻域, Inter-Orbit Neighborhood, , 轨道设计, 轨道力学, 地月转移, 周期轨道, 晕轨道
author: 天疆说
date: 2026-07-31
...
wechatShare:
  ...
  image: /logo.png
og:
  title: 站间邻域（Inter-Orbit Neighborhood）详解 | 术语定义
  description: 在不同轨道但共振比相同且太阳相位角相近的设施之间定义的邻域，用于跨轨道的设施替换。
  image: /logo.png
  type: article
twitter:
  ...
  description: 在不同轨道但共振比相同且太阳相位角相近的设施之间定义的邻域，用于跨轨道的设施替换。
  image: /logo.png
permalink: /glossary/orbits/inter-orbit-neighborhood/
---

# 站间邻域（Inter-Orbit Neighborhood）
...
在不同轨道但共振比相同且太阳相位角相近的设施之间定义的邻域，用于跨轨道的设施替换。
