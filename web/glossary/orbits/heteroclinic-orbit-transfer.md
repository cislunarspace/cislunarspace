...
description: 连接不同周期轨道或不同平动点附近Lyapunov轨道的轨道，可实现不同动力学区域之间的低能转移。
keywords: 异宿轨道转移, Heteroclinic Orbit Transfer
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 连接不同周期轨道或不同平动点附近Lyapunov轨道的轨道，可实现不同动力学区域之间的低能转移。
  image: /logo.png
permalink: /glossary/orbits/heteroclinic-orbit-transfer/
---

# 异宿轨道转移（Heteroclinic Orbit Transfer）
...
连接不同周期轨道或不同平动点附近Lyapunov轨道的轨道，可实现不同动力学区域之间的低能转移。
