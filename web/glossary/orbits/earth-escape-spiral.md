...
description: 从近地停泊轨道出发，小推力持续作用使航天器沿逐渐增大的螺旋轨道脱离地球引力束缚的飞行阶段。在旋转坐标系中表现为绕地球多圈的向外螺旋。以初始推重比3x10^-3的电推进为例，约需2.2天完成12圈螺旋逃逸。
...
twitter:
  ...
  description: 从近地停泊轨道出发，小推力持续作用使航天器沿逐渐增大的螺旋轨道脱离地球引力束缚的飞行阶段。在旋转坐标系中表现为绕地球多圈的向外螺旋。以初始推重比3x10^-3的电推进为例，约需2.2天完成12圈螺旋逃逸。
  image: /logo.png
permalink: /glossary/orbits/earth-escape-spiral/
---
...
逃逸螺旋是地月空间轨道设计中的核心概念，在任务规划阶段用于确定航天器的运动规律和轨道特性。在实际任务中，该轨道参数可用于计算转移 delta-V、飞行时间，以及与其他轨道的交汇条件，为轨道方案比选提供定量依据。
