...
循环轨道是周期性往返于地球和月球之间、在两者附近**绕飞而不停留**的轨道；其本质是地月限制性三体问题下往返地月间的一类周期轨道（彭坤、杨雷 2018）。面向任务需求，工程上**可采用**共振型循环轨道——轨道周期与地月系统周期成固定比例、近地点与近月点高度较低（注意共振是工程选择，不是本质属性）。同一概念在中文文献的另一译名是「地月周期重访轨道」（杨雷等 2013）。
