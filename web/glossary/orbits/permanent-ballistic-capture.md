---
title: 永久捕获（Permanent Ballistic Capture）
description: 航天器被月球捕获后一直保持捕获状态，需有耗散力作用。
keywords: 永久捕获, Permanent Ballistic Capture, 轨道设计, 周期轨道, 晕轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 航天器被月球捕获后一直保持捕获状态，需有耗散力作用。
  image: /logo.png
permalink: /glossary/orbits/permanent-ballistic-capture/
---

# 永久捕获（Permanent Ballistic Capture）
...
航天器被月球捕获后一直保持捕获状态，需有耗散力作用。

## 应用价值

永久捕获是地月空间轨道设计中的核心概念，在任务规划阶段用于确定航天器的运动规律和轨道特性。在实际任务中，该轨道参数可用于计算转移 delta-V、飞行时间，以及与其他轨道的交汇条件，为轨道方案比选提供定量依据。
