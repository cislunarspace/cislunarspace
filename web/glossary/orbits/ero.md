...
description: Hénon在Hill修改的三体问题中发现的一类不稳定周期轨道族（a族）。航天器沿ERO周期性地接近并远离地球，当轨道继续延伸至L1点附近时，退化为简单的准椭圆HLO。ERO的半程路径可作为从LEO到DRO转移轨道的一部分，是Ocampo经典转移方法的基础。
...
地球返回轨道是航天器从月球返回地球的转移轨道，需考虑再入条件和落点精度。
