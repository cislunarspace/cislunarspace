...
description: 以月球为中心的轨道，包括远距离逆行轨道（DRO）、远距离顺行轨道（DPO）和低顺行轨道（LoPO），可从月球二体问题的初值猜测得到。
keywords: 月心轨道, Moon-centered Orbit, 轨道设计, 轨道转移, 周期轨道
author: 天疆说
date: 2026-07-31
...
以月球为中心的轨道，包括远距离逆行轨道（DRO）、远距离顺行轨道（DPO）和低顺行轨道（LoPO），可从月球二体问题的初值猜测得到。
