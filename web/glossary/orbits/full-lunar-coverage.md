---
title: 全月面覆盖轨道（Full Lunar Surface Coverage Orbit）
description: 详细解析全月面覆盖轨道的定义、不变流形着陆、周期轨道振幅与覆盖性关系及其在月球探测中的应用
keywords: 全月面覆盖轨道, Full Lunar Surface Coverage, 月球探测, 不变流形, Halo轨道, NRHO, 月球门户, 轨道设计
author: 天疆说
date: 2026-04-29
...
wechatShare:
  ...
  image: /logo.png
og:
  title: 全月面覆盖轨道（Full Lunar Surface Coverage Orbit）详解 | 月球全球覆盖
  description: 详细解析全月面覆盖轨道的定义、不变流形着陆、周期轨道振幅与覆盖性关系及其在月球探测中的应用
  image: /logo.png
  type: article
twitter:
  ...
  description: 详细解析全月面覆盖轨道的定义、不变流形着陆、周期轨道振幅与覆盖性关系及其在月球探测中的应用
  image: /logo.png
permalink: /glossary/orbits/full-lunar-coverage/
---
...
全月面覆盖轨道（Full Lunar Surface Coverage Orbit）是**能够实现月球全球表面覆盖的轨道设计**，是未来月球探测的关键需求。利用三体系统的不变流形可从平衡点轨道实现弹道着陆，但自然流形覆盖区域有限。不同振幅的周期轨道对月面覆盖性不同：小振幅轨道对月面整体覆盖性较好，大振幅轨道对月球极地覆盖较好。NASA 月球门户计划以 NRHO 为参考轨道。
