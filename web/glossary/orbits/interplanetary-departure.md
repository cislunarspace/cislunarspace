---
title: 行星际出发（Interplanetary Departure）
description: 航天器离开行星引力场的阶段。
keywords: 行星际出发, Interplanetary Departure, 轨道设计, 轨道力学, 平动点
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 航天器离开行星引力场的阶段。
  image: /logo.png
permalink: /glossary/orbits/interplanetary-departure/
---

# 行星际出发（Interplanetary Departure）
...
行星际出发是地月空间轨道设计中的重要概念，用于描述航天器在地月引力场中的运动特性。
