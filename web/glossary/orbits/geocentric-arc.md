...
description: 以地球为主吸引体的轨道转移段，使用地心modified equinoctial elements（MEE）进行传播。
...
wechatShare:
  ...
  image: /logo.png
og:
  title: 地心弧段（Geocentric Arc）详解 | 术语定义
  description: 以地球为主吸引体的轨道转移段，使用地心modified equinoctial elements（MEE）进行传播。
  image: /logo.png
  type: article
twitter:
...
以地球为主吸引体的轨道转移段，使用地心modified equinoctial elements（MEE）进行传播。
