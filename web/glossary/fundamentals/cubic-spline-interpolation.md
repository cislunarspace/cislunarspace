...
description: 一种通过三次多项式分段拟合数据点并保证曲线光滑连续的方法，用于计算期望相对路径及其时间导数。
keywords: 三次样条插值, Cubic Spline Interpolation, 轨道力学, 航天动力学, 数值方法
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 一种通过三次多项式分段拟合数据点并保证曲线光滑连续的方法，用于计算期望相对路径及其时间导数。
  image: /logo.png
permalink: /glossary/fundamentals/cubic-spline-interpolation/
---
...
一种通过三次多项式分段拟合数据点并保证曲线光滑连续的方法，用于计算期望相对路径及其时间导数。
