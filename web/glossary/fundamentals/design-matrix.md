---
title: 设计矩阵（Design matrix）
description: 卡尔曼滤波中测量模型对待估状态的偏导数矩阵，描述测量值对状态变化的敏感程度。在EKF测量更新中用于计算卡尔曼增益和更新状态协方差。
keywords: 设计矩阵, Design matrix, H, 基础, 坐标, 积分
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 卡尔曼滤波中测量模型对待估状态的偏导数矩阵，描述测量值对状态变化的敏感程度。在EKF测量更新中用于计算卡尔曼增益和更新状态协方差。
  image: /logo.png
permalink: /glossary/fundamentals/design-matrix/
---
...
卡尔曼滤波中测量模型对待估状态的偏导数矩阵，描述测量值对状态变化的敏感程度。在EKF测量更新中用于计算卡尔曼增益和更新状态协方差。
