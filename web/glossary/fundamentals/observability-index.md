---
title: 可观测性指数（Observability index）
description: 格兰姆矩阵的最小特征值。用于衡量系统的可观测程度，大于10的负3次方时表示系统可观测性较好。与具体估计方法或过程无关。
keywords: 可观测性指数, Observability index, O_I, 参考系, 坐标变换, 基本概念
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 格兰姆矩阵的最小特征值。用于衡量系统的可观测程度，大于10的负3次方时表示系统可观测性较好。与具体估计方法或过程无关。
  image: /logo.png
permalink: /glossary/fundamentals/observability-index/
---
...
格兰姆矩阵的最小特征值。用于衡量系统的可观测程度，大于10的负3次方时表示系统可观测性较好。与具体估计方法或过程无关。

## 应用价值

观测能力是空间态势感知的基础，高精度的测量技术对轨道确定和安全运行至关重要。
