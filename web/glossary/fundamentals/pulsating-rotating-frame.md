---
title: 脉动旋转坐标系（Pulsating-Rotating Frame）
description: 随轨道一起脉动并旋转的参考坐标系，用于可视化三体问题中的轨迹。
keywords: 轨道, 物理, 天文, 基础
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 随轨道一起脉动并旋转的参考坐标系，用于可视化三体问题中的轨迹。
  image: /logo.png
permalink: /glossary/fundamentals/pulsating-rotating-frame/
---

# 脉动旋转坐标系（Pulsating-Rotating Frame）
...
随轨道一起脉动并旋转的参考坐标系，用于可视化三体问题中的轨迹。
