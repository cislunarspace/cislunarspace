---
title: 月心惯性系（Selenocentric Inertial Coordinate System）
description: 以月球中心为原点的惯性坐标系。本文定义XY平面为白道面，X轴与初始时刻的地月连线一致。该坐标系不随月球公转而旋转，用于描述平动点轨道在月心参考系下的状态。
...
twitter:
  ...
  description: 以月球中心为原点的惯性坐标系。本文定义XY平面为白道面，X轴与初始时刻的地月连线一致。该坐标系不随月球公转而旋转，用于描述平动点轨道在月心参考系下的状态。
  image: /logo.png
permalink: /glossary/fundamentals/selenocentric-inertial-coordinate-system/
---

# 月心惯性系（Selenocentric Inertial Coordinate System）
...
以月球中心为原点的惯性坐标系。本文定义XY平面为白道面，X轴与初始时刻的地月连线一致。该坐标系不随月球公转而旋转，用于描述平动点轨道在月心参考系下的状态。
