---
title: 惯性坐标系（Inertial Reference Frame）
description: 坐标轴指向固定的惯性参考方向（如JPL DE200星历定义的春分点方向）的坐标系。
keywords: 惯性坐标系, Inertial Reference Frame, 轨道力学, 航天动力学, 数值方法
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 坐标轴指向固定的惯性参考方向（如JPL DE200星历定义的春分点方向）的坐标系。
  image: /logo.png
permalink: /glossary/fundamentals/inertial-reference-frame/
---

# 惯性坐标系（Inertial Reference Frame）
...
坐标轴指向固定的惯性参考方向（如JPL DE200星历定义的春分点方向）的坐标系。
