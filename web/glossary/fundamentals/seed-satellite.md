---
title: 种子卫星（Seed Satellite）
description: 同一轨道上作为相位参考基准的卫星。其他卫星的位置和相位偏移均相对于这颗卫星定义。
keywords: 种子卫星, Seed Satellite, 轨道力学, 航天动力学, 数值方法
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 同一轨道上作为相位参考基准的卫星。其他卫星的位置和相位偏移均相对于这颗卫星定义。
  image: /logo.png
permalink: /glossary/fundamentals/seed-satellite/
---
...
同一轨道上作为相位参考基准的卫星。其他卫星的位置和相位偏移均相对于这颗卫星定义。
