---
title: 切向逃逸（Tangential Escape）
description: 探测器沿轨道速度方向加速，使逃逸方向与当前位置矢量垂直的机动方式。切向逃逸能最大化利用推进能量，避免法向速度分量的浪费，是从近地轨道进入转移轨道的最优逃逸策略。
keywords: 切向逃逸, Tangential Escape, 基础, 坐标, 积分
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 探测器沿轨道速度方向加速，使逃逸方向与当前位置矢量垂直的机动方式。切向逃逸能最大化利用推进能量，避免法向速度分量的浪费，是从近地轨道进入转移轨道的最优逃逸策略。
  image: /logo.png
permalink: /glossary/fundamentals/tangential-escape/
---

# 切向逃逸（Tangential Escape）
...
探测器沿轨道速度方向加速，使逃逸方向与当前位置矢量垂直的机动方式。切向逃逸能最大化利用推进能量，避免法向速度分量的浪费，是从近地轨道进入转移轨道的最优逃逸策略。
