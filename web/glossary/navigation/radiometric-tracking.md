---
title: 测距跟踪（Radiometric Tracking）
description: 通过地面站测量信号实现航天器跟踪的传统方法，如深空网络和跟踪与数据中继卫星系统。
keywords: 测距跟踪, Radiometric Tracking, 导航, 定位, 轨道确定
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 通过地面站测量信号实现航天器跟踪的传统方法，如深空网络和跟踪与数据中继卫星系统。
  image: /logo.png
permalink: /glossary/navigation/radiometric-tracking/
---

# 测距跟踪（Radiometric Tracking）
...
通过地面站测量信号实现航天器跟踪的传统方法，如深空网络和跟踪与数据中继卫星系统。
