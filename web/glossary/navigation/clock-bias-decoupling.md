---
title: 钟差解耦（Clock Bias Decoupling）
description: 通过双单向测距的正反向测距值相减，消除距离项而分离出相对钟差信息的过程。
keywords: 钟差解耦, Clock Bias Decoupling, 导航, 定位, 轨道确定
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 通过双单向测距的正反向测距值相减，消除距离项而分离出相对钟差信息的过程。
  image: /logo.png
permalink: /glossary/navigation/clock-bias-decoupling/
---

# 钟差解耦（Clock Bias Decoupling）
...
通过双单向测距的正反向测距值相减，消除距离项而分离出相对钟差信息的过程。
