---
title: 辅助航天器（Auxiliary Spacecraft）
description: 在星间链路自主轨道确定系统中，配合核心航天器工作、提供辅助测距信息的航天器。辅助航天器的轨道类型对系统可观测性和最终定轨精度有显著影响。
keywords: 辅助航天器, Auxiliary Spacecraft, 导航, 定位, 轨道确定
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 在星间链路自主轨道确定系统中，配合核心航天器工作、提供辅助测距信息的航天器。辅助航天器的轨道类型对系统可观测性和最终定轨精度有显著影响。
  image: /logo.png
permalink: /glossary/navigation/auxiliary-spacecraft/
---

# 辅助航天器（Auxiliary Spacecraft）
...
在星间链路自主轨道确定系统中，配合核心航天器工作、提供辅助测距信息的航天器。辅助航天器的轨道类型对系统可观测性和最终定轨精度有显著影响。
