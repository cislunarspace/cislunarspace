---
title: 相对姿态估计（Relative Pose Estimation）
description: 确定追踪航天器相对目标的位置与姿态
keywords: 相对姿态估计, Relative Pose Estimation, 导航, 轨道确定, 测量
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 确定追踪航天器相对目标的位置与姿态
  image: /logo.png
permalink: /glossary/navigation/relative-pose-estimation/
---
