---
title: 星间联合定轨（Inter-Satellite Joint Orbit Determination）
description: 仅依靠星间链路测量数据，不依赖或少量依赖地面站数据进行的导航卫星精密定轨方法。是实现导航卫星自主导航的核心技术，可显著增强系统的自主运行能力。
keywords: 星间联合定轨, Inter-Satellite Joint Orbit Determination, 导航, 定位, 轨道确定
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 仅依靠星间链路测量数据，不依赖或少量依赖地面站数据进行的导航卫星精密定轨方法。是实现导航卫星自主导航的核心技术，可显著增强系统的自主运行能力。
  image: /logo.png
permalink: /glossary/navigation/inter-satellite-joint-orbit-determination/
---

# 星间联合定轨（Inter-Satellite Joint Orbit Determination）
...
仅依靠星间链路测量数据，不依赖或少量依赖地面站数据进行的导航卫星精密定轨方法。是实现导航卫星自主导航的核心技术，可显著增强系统的自主运行能力。
