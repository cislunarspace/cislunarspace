...
description: 仅依赖系统实时状态反馈进行控制量计算的方法，不包含系统动态模型信息，适用于在线实时控制。
keywords: 无模型控制, Model-Free Control, 轨道力学, 姿态控制, 相对运动
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 仅依赖系统实时状态反馈进行控制量计算的方法，不包含系统动态模型信息，适用于在线实时控制。
  image: /logo.png
permalink: /glossary/dynamics/model-free-control/
---
...
仅依赖系统实时状态反馈进行控制量计算的方法，不包含系统动态模型信息，适用于在线实时控制。
