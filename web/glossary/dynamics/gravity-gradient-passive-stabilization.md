---
title: 重力梯度被动稳定（Gravity Gradient Passive Stabilization）
description: 利用重力梯度力矩使零动量卫星在轨道上被动保持姿态稳定的方法。
keywords: 重力梯度被动稳定, Gravity Gradient Passive Stabilization, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 利用重力梯度力矩使零动量卫星在轨道上被动保持姿态稳定的方法。
  image: /logo.png
permalink: /glossary/dynamics/gravity-gradient-passive-stabilization/
---

# 重力梯度被动稳定（Gravity Gradient Passive Stabilization）
