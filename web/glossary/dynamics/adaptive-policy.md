---
title: 自适应策略（Adaptive Policy）
description: 能够根据环境观察动态调整内部状态的策略，LSTM隐藏状态使其成为可能。
keywords: 自适应策略, Adaptive Policy, 轨道力学, 最优控制, 轨迹优化
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 能够根据环境观察动态调整内部状态的策略，LSTM隐藏状态使其成为可能。
  image: /logo.png
permalink: /glossary/dynamics/adaptive-policy/
---

# 自适应策略（Adaptive Policy）
...
能够根据环境观察动态调整内部状态的策略，LSTM隐藏状态使其成为可能。
