---
title: 弗洛凯-李雅普诺夫定理（Floquet-Lyapunov Theorem）
description: 周期哈密顿系统的基本矩阵解可分解为周期辛矩阵与指数矩阵的乘积。
keywords: 弗洛凯-李雅普诺夫定理, Floquet-Lyapunov Theorem, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 周期哈密顿系统的基本矩阵解可分解为周期辛矩阵与指数矩阵的乘积。
  image: /logo.png
permalink: /glossary/dynamics/floquet-lyapunov-theorem/
---

# 弗洛凯-李雅普诺夫定理（Floquet-Lyapunov Theorem）
...
周期哈密顿系统的基本矩阵解可分解为周期辛矩阵与指数矩阵的乘积。
