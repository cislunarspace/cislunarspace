---
title: 机动阈值（Maneuver Threshold）
description: 若计算得到的机动力度小于该阈值则取消机动的门限值。
keywords: 机动阈值, Maneuver Threshold, 轨道力学, 姿态控制, 相对运动
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 若计算得到的机动力度小于该阈值则取消机动的门限值。
  image: /logo.png
permalink: /glossary/dynamics/maneuver-threshold/
---

# 机动阈值（Maneuver Threshold）
