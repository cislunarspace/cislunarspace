---
title: 永久捕获（Permanent Capture）
description: 航天器的雅可比常数降至 L1 点雅可比常数以下时，其运动被能量约束在月球附近的物理状态。在 PCR3BP 中这是严格条件：一旦满足，航天器将无法在无推力情况下离开月球区域。
keywords: 永久捕获, Permanent Capture, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 航天器的雅可比常数降至 L1 点雅可比常数以下时，其运动被能量约束在月球附近的物理状态。在 PCR3BP 中这是严格条件：一旦满足，航天器将无法在无推力情况下离开月球区域。
  image: /logo.png
permalink: /glossary/dynamics/permanent-capture/
---
...
航天器的雅可比常数降至 L1 点雅可比常数以下时，其运动被能量约束在月球附近的物理状态。在 PCR3BP 中这是严格条件：一旦满足，航天器将无法在无推力情况下离开月球区域。
