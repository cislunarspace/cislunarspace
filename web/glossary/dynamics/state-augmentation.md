---
title: 状态增广（State Augmentation）
description: 将新估计的状态（如路标位置）添加到状态向量中进行联合估计的技术
keywords: 状态增广, State Augmentation, 轨道优化, 控制理论, 非线性控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 将新估计的状态（如路标位置）添加到状态向量中进行联合估计的技术
  image: /logo.png
permalink: /glossary/dynamics/state-augmentation/
---
...
将新估计的状态（如路标位置）添加到状态向量中进行联合估计的技术
