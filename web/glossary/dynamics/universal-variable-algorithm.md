---
title: 通用变量算法（Universal Variable Algorithm）
description: 利用Lagrange系数和Stumpff函数构造代数解的半解析方法，用于求解标准Lambert问题。
keywords: Universal Variable Algorithm, 三体问题, 动力学分叉, 轨道力学, 通用变量算法
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 利用Lagrange系数和Stumpff函数构造代数解的半解析方法，用于求解标准Lambert问题。
  image: /logo.png
permalink: /glossary/dynamics/universal-variable-algorithm/
---
...
利用Lagrange系数和Stumpff函数构造代数解的半解析方法，用于求解标准Lambert问题。
