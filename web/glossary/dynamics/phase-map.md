---
title: 相位图（Phase Map）
description: 在由太阳角定义的超平面上记录正向与反向传播轨迹段交点，并通过最近邻搜索识别其中close match的地图工具。
keywords: 相位图, Phase Map, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 在由太阳角定义的超平面上记录正向与反向传播轨迹段交点，并通过最近邻搜索识别其中close match的地图工具。
  image: /logo.png
permalink: /glossary/dynamics/phase-map/
---
...
在由太阳角定义的超平面上记录正向与反向传播轨迹段交点，并通过最近邻搜索识别其中close match的地图工具。
