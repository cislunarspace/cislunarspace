---
title: 有效相位平面（Effective Phases Plane）
description: 以有效相位(Φ,Ψ)为坐标的平面，可将Lissajous轨道表示为直线，便于任务设计。
keywords: 有效相位平面, Effective Phases Plane, EPP, 轨道力学, 动力学, 控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 以有效相位(Φ,Ψ)为坐标的平面，可将Lissajous轨道表示为直线，便于任务设计。
  image: /logo.png
permalink: /glossary/dynamics/epp/
---

# 有效相位平面（Effective Phases Plane）
...
以有效相位(Φ,Ψ)为坐标的平面，可将Lissajous轨道表示为直线，便于任务设计。
