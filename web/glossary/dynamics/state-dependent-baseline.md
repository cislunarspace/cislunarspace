---
title: 状态依赖基准（State-Dependent Baseline）
description: 在强化学习中用状态值函数作为基准来估计动作优势，可降低方差并提高学习性能。
keywords: 状态依赖基准, State-Dependent Baseline, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 在强化学习中用状态值函数作为基准来估计动作优势，可降低方差并提高学习性能。
  image: /logo.png
permalink: /glossary/dynamics/state-dependent-baseline/
---

# 状态依赖基准（State-Dependent Baseline）
...
在强化学习中用状态值函数作为基准来估计动作优势，可降低方差并提高学习性能。
