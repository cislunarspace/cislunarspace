---
title: 到达偏转角（Arrival Deflection Angle）
description: 到达DRO时的脉冲速度矢量相对于DRO当地速度矢量的夹角。逆时针为正，顺时针为负。
keywords: 到达偏转角, Arrival Deflection Angle, 轨道动力学, 多体问题, 摄动
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 到达DRO时的脉冲速度矢量相对于DRO当地速度矢量的夹角。逆时针为正，顺时针为负。
  image: /logo.png
permalink: /glossary/dynamics/arrival-deflection-angle/
---

# 到达偏转角（Arrival Deflection Angle）
...
到达DRO时的脉冲速度矢量相对于DRO当地速度矢量的夹角。逆时针为正，顺时针为负。
