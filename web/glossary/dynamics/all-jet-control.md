---
title: 全喷气控制（All-jet Control）
description: 仅用喷气推力器实现姿态控制的方式，不使用动量装置。
keywords: 全喷气控制, All-jet Control, 轨道动力学, 控制理论, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 仅用喷气推力器实现姿态控制的方式，不使用动量装置。
  image: /logo.png
permalink: /glossary/dynamics/all-jet-control/
---

# 全喷气控制（All-jet Control）
...
仅用喷气推力器实现姿态控制的方式，不使用动量装置。

## 应用价值

全喷气控制在轨道设计和轨迹优化中用于将连续控制问题离散化，通过非线性规划求解最优控制序列。
