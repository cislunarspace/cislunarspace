---
title: 注入误差（Injection Error）
description: 航天器初始位置和速度相对于标称值的偏差，用于测试控制器的响应特性。
keywords: 注入误差, Injection Error, 轨道设计, 最优控制, 动力学建模, 脉冲机动
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 航天器初始位置和速度相对于标称值的偏差，用于测试控制器的响应特性。
  image: /logo.png
permalink: /glossary/dynamics/injection-error/
---

# 注入误差（Injection Error）
...
航天器初始位置和速度相对于标称值的偏差，用于测试控制器的响应特性。
