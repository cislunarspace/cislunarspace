---
title: 可达性分析（Reachability Analysis）
description: 研究系统能否从初始状态集转换到目标状态集的方法，用于验证安全性和约束满足性。
keywords: 可达性分析, Reachability Analysis, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 研究系统能否从初始状态集转换到目标状态集的方法，用于验证安全性和约束满足性。
  image: /logo.png
permalink: /glossary/dynamics/reachability-analysis/
---
...
研究系统能否从初始状态集转换到目标状态集的方法，用于验证安全性和约束满足性。
