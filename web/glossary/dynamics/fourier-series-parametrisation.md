---
title: 傅里叶级数参数化（Fourier Series Parametrisation）
description: 用有限项傅里叶级数表示不变曲线或环面的方法，是数值计算不变环面的基础。
keywords: 傅里叶级数参数化, Fourier Series Parametrisation, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 用有限项傅里叶级数表示不变曲线或环面的方法，是数值计算不变环面的基础。
  image: /logo.png
permalink: /glossary/dynamics/fourier-series-parametrisation/
---

# 傅里叶级数参数化（Fourier Series Parametrisation）
...
用有限项傅里叶级数表示不变曲线或环面的方法，是数值计算不变环面的基础。
