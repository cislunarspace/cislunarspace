---
title: 禁用区域（Forbidden Region）
description: 雅可比常数约束下，航天器因动能不足而无法到达的空间区域。
keywords: 禁用区域, Forbidden Region, 轨道优化, 控制理论, 非线性控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 雅可比常数约束下，航天器因动能不足而无法到达的空间区域。
  image: /logo.png
permalink: /glossary/dynamics/forbidden-region/
---

# 禁用区域（Forbidden Region）
