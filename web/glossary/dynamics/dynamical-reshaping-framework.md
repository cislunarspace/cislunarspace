---
title: 动力学重构框架（Dynamical Reshaping Framework）
description: 基于动力学系统特征的轨道保持框架，通过选择算法参数来调整性能，实现不稳定和中心弗洛凯模态的重塑。
keywords: 动力学重构框架, Dynamical Reshaping Framework, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 基于动力学系统特征的轨道保持框架，通过选择算法参数来调整性能，实现不稳定和中心弗洛凯模态的重塑。
  image: /logo.png
permalink: /glossary/dynamics/dynamical-reshaping-framework/
---

# 动力学重构框架（Dynamical Reshaping Framework）
...
基于动力学系统特征的轨道保持框架，通过选择算法参数来调整性能，实现不稳定和中心弗洛凯模态的重塑。
