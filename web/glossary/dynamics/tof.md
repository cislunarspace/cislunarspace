---
title: 飞行时间（Time of Flight, ToF）
description: 从初始位置到最终位置的转移时间，是Lambert问题的三个边界条件之一。
keywords: 飞行时间, Time of Flight, ToF, ToF, dynamics
author: 天疆说
date: 2026-07-31
...
从初始位置到最终位置的转移时间，是Lambert问题的三个边界条件之一。
