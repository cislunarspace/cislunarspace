---
title: 单框力矩陀螺（Single Gimbal CMG）
description: 只有一个框架轴的力矩陀螺，可产生垂直于框架轴的力矩。
keywords: 单框力矩陀螺, Single Gimbal CMG, 轨道动力学, 控制理论, 数值仿真
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 只有一个框架轴的力矩陀螺，可产生垂直于框架轴的力矩。
  image: /logo.png
permalink: /glossary/dynamics/single-gimbal-cmg/
---

# 单框力矩陀螺（Single Gimbal CMG）
...
只有一个框架轴的力矩陀螺，可产生垂直于框架轴的力矩。

## 应用价值

单框力矩陀螺涉及地月空间航天器的运动特性分析和控制问题。在实际任务设计中，利用该方法可以分析轨道稳定性、计算控制策略，或评估摄动因素对轨道的影响，为任务安全性和可靠性提供保障。
