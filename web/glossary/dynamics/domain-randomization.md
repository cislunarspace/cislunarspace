...
description: 在训练过程中随机化环境参数以增强策略泛化能力的方法。
keywords: 域随机化, Domain Randomization, 轨道动力学, 三体问题, 平动点
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 在训练过程中随机化环境参数以增强策略泛化能力的方法。
  image: /logo.png
permalink: /glossary/dynamics/domain-randomization/
---
