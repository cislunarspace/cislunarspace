...
description: 一类模拟自然进化过程的优化算法，包括遗传算法、粒子群优化等。优点是不需要梯度信息且能搜索全局最优。
keywords: 进化算法, Evolutionary Algorithm, EA, 轨道优化, 控制理论
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 一类模拟自然进化过程的优化算法，包括遗传算法、粒子群优化等。优点是不需要梯度信息且能搜索全局最优。
  image: /logo.png
permalink: /glossary/dynamics/evolutionary-algorithm/
---
...
一类模拟自然进化过程的优化算法，包括遗传算法、粒子群优化等。优点是不需要梯度信息且能搜索全局最优。
