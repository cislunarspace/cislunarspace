---
title: 比例-微分控制（Proportional-Derivative Control, PD Control）
description: 由比例增益和微分增益组成的反馈控制律，用于跟踪期望相对轨道状态。
keywords: 比例-微分控制, Proportional-Derivative Control, PD Control, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 由比例增益和微分增益组成的反馈控制律，用于跟踪期望相对轨道状态。
  image: /logo.png
permalink: /glossary/dynamics/proportional-derivative-control-pd-control/
---
...
由比例增益和微分增益组成的反馈控制律，用于跟踪期望相对轨道状态。
