---
title: 最大加速度（Maximum Acceleration）
description: 推力加速度的幅值上限。低推力电推进系统的最大加速度远小于化学推进，是决定转移时间与燃料消耗的关键参数。
keywords: 最大加速度, Maximum Acceleration, umax, 动力学, 非线性, 稳定性, 流形, 控制
author: 天疆说
date: 2026-07-31
...
wechatShare:
  ...
  image: /logo.png
og:
  title: 最大加速度（Maximum Acceleration）详解 | 术语定义
  description: 推力加速度的幅值上限。低推力电推进系统的最大加速度远小于化学推进，是决定转移时间与燃料消耗的关键参数。
  image: /logo.png
  type: article
twitter:
  ...
  description: 推力加速度的幅值上限。低推力电推进系统的最大加速度远小于化学推进，是决定转移时间与燃料消耗的关键参数。
  image: /logo.png
permalink: /glossary/dynamics/maximum-acceleration/
---
...
推力加速度的幅值上限。低推力电推进系统的最大加速度远小于化学推进，是决定转移时间与燃料消耗的关键参数。
