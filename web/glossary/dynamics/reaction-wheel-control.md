---
title: 反作用轮控制（Reaction Wheel Control）
description: 利用反作用轮角动量交换实现姿态控制的方式。
keywords: 反作用轮控制, Reaction Wheel Control, 轨道动力学, 控制理论, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 利用反作用轮角动量交换实现姿态控制的方式。
  image: /logo.png
permalink: /glossary/dynamics/reaction-wheel-control/
---

# 反作用轮控制（Reaction Wheel Control）
...
利用反作用轮角动量交换实现姿态控制的方式。

## 应用价值

反作用轮控制在轨道设计和轨迹优化中用于将连续控制问题离散化，通过非线性规划求解最优控制序列。
