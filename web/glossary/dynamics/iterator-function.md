---
title: 迭代函数（Iterator Function）
description: 利用前 k 次出离角与飞行时间估计值，通过数值迭代寻找满足目标飞行时间之出离角的函数。
keywords: 迭代函数, Iterator Function, h(), 轨道动力学, 姿态控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 利用前 k 次出离角与飞行时间估计值，通过数值迭代寻找满足目标飞行时间之出离角的函数。
  image: /logo.png
permalink: /glossary/dynamics/iterator-function/
---

# 迭代函数（Iterator Function）
...
利用前 k 次出离角与飞行时间估计值，通过数值迭代寻找满足目标飞行时间之出离角的函数。
