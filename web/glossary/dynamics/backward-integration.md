---
title: 后向积分（Backward Integration）
description: 沿DRL生成的轨迹反向积分协态方程，以估计协态变量初值的方法，为间接优化提供初始猜测。
keywords: 后向积分, Backward Integration, 轨道动力学, 多体问题, 摄动
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 沿DRL生成的轨迹反向积分协态方程，以估计协态变量初值的方法，为间接优化提供初始猜测。
  image: /logo.png
permalink: /glossary/dynamics/backward-integration/
---

# 后向积分（Backward Integration）
...
沿DRL生成的轨迹反向积分协态方程，以估计协态变量初值的方法，为间接优化提供初始猜测。
