---
title: 动力学重构策略（Dynamical Reshaping Strategy）
description: 利用轨道附近的相空间几何结构，通过低推力推进将不稳定的弗洛凯模态重塑为稳定模态的轨道保持方法。
keywords: 动力学重构策略, Dynamical Reshaping Strategy, 轨道优化, 控制理论, 非线性控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 利用轨道附近的相空间几何结构，通过低推力推进将不稳定的弗洛凯模态重塑为稳定模态的轨道保持方法。
  image: /logo.png
permalink: /glossary/dynamics/dynamical-reshaping-strategy/
---

# 动力学重构策略（Dynamical Reshaping Strategy）
...
利用轨道附近的相空间几何结构，通过低推力推进将不稳定的弗洛凯模态重塑为稳定模态的轨道保持方法。
