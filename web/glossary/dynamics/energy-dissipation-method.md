---
title: 能量耗散法（Energy Dissipation Method）
description: 通过分析系统能量耗散研究双旋卫星姿态稳定性的方法。
keywords: 能量耗散法, Energy Dissipation Method, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 通过分析系统能量耗散研究双旋卫星姿态稳定性的方法。
  image: /logo.png
permalink: /glossary/dynamics/energy-dissipation-method/
---
