---
title: 留（Station）
description: 行星从顺行转为逆行或逆行转为顺行的转折点。
keywords: 留, Station, 轨道动力学, 三体问题, 平动点
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 行星从顺行转为逆行或逆行转为顺行的转折点。
  image: /logo.png
permalink: /glossary/dynamics/station/
---
...
>
> 术语来源：肖峰 - 1989 - 球面天文学与天体力学基础
>
> 本文地址：[https://cislunarspace.cn](https://cislunarspace.cn)

## 定义

行星从顺行转为逆行或逆行转为顺行的转折点。

## 应用价值

留在地月空间动力学分析和任务轨道设计中具有应用价值。正确理解和应用留有助于优化轨道设计、控制策略和任务规划，是地月空间任务工程师需要掌握的基础知识。
