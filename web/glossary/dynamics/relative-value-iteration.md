---
title: 相对值迭代（Relative Value Iteration）
description: 求解截断MDP问题最优策略的迭代算法，通过不断更新值函数直至收敛得到最优调度策略。
keywords: 相对值迭代, Relative Value Iteration, RVI, 轨道优化, 控制理论
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 求解截断MDP问题最优策略的迭代算法，通过不断更新值函数直至收敛得到最优调度策略。
  image: /logo.png
permalink: /glossary/dynamics/relative-value-iteration/
---

# 相对值迭代（Relative Value Iteration）
...
求解截断MDP问题最优策略的迭代算法，通过不断更新值函数直至收敛得到最优调度策略。
