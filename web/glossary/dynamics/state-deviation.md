---
title: 状态偏差（State Deviation）
description: 航天器状态向量与标称状态之间的差，包含位置和速度分量。
keywords: 状态偏差, State Deviation, 轨道动力学, 三体问题, 平动点
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 航天器状态向量与标称状态之间的差，包含位置和速度分量。
  image: /logo.png
permalink: /glossary/dynamics/state-deviation/
---

# 状态偏差（State Deviation）
...
航天器状态向量与标称状态之间的差，包含位置和速度分量。

## 应用价值

状态偏差在地月空间动力学分析和任务轨道设计中具有应用价值。正确理解和应用状态偏差有助于优化轨道设计、控制策略和任务规划，是地月空间任务工程师需要掌握的基础知识。
