...
description: 包含多段弧、最优控制问题需在弧间施加角点条件的最优控制框架。
keywords: 多弧段最优控制, Multi-arc Optimal Control, 轨道动力学, 控制理论, 数值仿真
author: 天疆说
date: 2026-07-31
...
包含多段弧、最优控制问题需在弧间施加角点条件的最优控制框架。

## 应用价值

多弧段最优控制涉及地月空间航天器的运动特性分析和控制问题。在实际任务设计中，利用该方法可以分析轨道稳定性、计算控制策略，或评估摄动因素对轨道的影响，为任务安全性和可靠性提供保障。
