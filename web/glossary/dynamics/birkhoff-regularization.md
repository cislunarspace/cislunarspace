---
title: 比尔克霍夫正则化（Birkhoff Regularization）
description: 实现全局正则化的方法，同时消除两个天体的碰撞奇点。通过扩展相空间维度并引入新的正则坐标，将碰撞轨道转化为正规轨道。
keywords: 比尔克霍夫正则化, Birkhoff Regularization, 轨道优化, 控制理论, 非线性控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 实现全局正则化的方法，同时消除两个天体的碰撞奇点。通过扩展相空间维度并引入新的正则坐标，将碰撞轨道转化为正规轨道。
  image: /logo.png
permalink: /glossary/dynamics/birkhoff-regularization/
---

# 比尔克霍夫正则化（Birkhoff Regularization）
...
实现全局正则化的方法，同时消除两个天体的碰撞奇点。通过扩展相空间维度并引入新的正则坐标，将碰撞轨道转化为正规轨道。
