---
title: 故障检测与恢复（Fault Detection, Isolation and Recovery, FDIR）
description: 检测、隔离系统故障并自动恢复的技术，是提高任务可靠性和自主性的关键使能技术。
keywords: 故障检测与恢复, Fault Detection, Isolation and Recovery, FDIR, FDIR, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 检测、隔离系统故障并自动恢复的技术，是提高任务可靠性和自主性的关键使能技术。
  image: /logo.png
permalink: /glossary/dynamics/fault-detection-isolation-and-recovery-fdir/
---
...
检测、隔离系统故障并自动恢复的技术，是提高任务可靠性和自主性的关键使能技术。
