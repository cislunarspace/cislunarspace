---
title: 主航天器（Chief Spacecraft）
description: 在编队飞行或交会对接任务中，被作为参考目标的航天器。其运动状态用于定义相对运动的基准。
keywords: 主航天器, Chief Spacecraft, , 动力学, 非线性, 稳定性, 流形, 控制
author: 天疆说
date: 2026-07-31
...
wechatShare:
  ...
  image: /logo.png
og:
  title: 主航天器（Chief Spacecraft）详解 | 术语定义
  description: 在编队飞行或交会对接任务中，被作为参考目标的航天器。其运动状态用于定义相对运动的基准。
  image: /logo.png
  type: article
twitter:
  ...
  description: 在编队飞行或交会对接任务中，被作为参考目标的航天器。其运动状态用于定义相对运动的基准。
  image: /logo.png
permalink: /glossary/dynamics/chief-spacecraft/
---

# 主航天器（Chief Spacecraft）
...
在编队飞行或交会对接任务中，被作为参考目标的航天器。其运动状态用于定义相对运动的基准。
