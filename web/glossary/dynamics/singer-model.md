---
title: Singer模型（Singer Model）
description: 一种常用的目标机动模型，将机动加速度建模为自相关随机过程
keywords: Singer模型, Singer Model
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 一种常用的目标机动模型，将机动加速度建模为自相关随机过程
  image: /logo.png
permalink: /glossary/dynamics/singer-model/
---

# Singer模型（Singer Model）
