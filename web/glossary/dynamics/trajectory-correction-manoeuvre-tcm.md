---
title: 轨迹修正机动（Trajectory Correction Manoeuvre, TCM）
description: 转移轨道上为修正入轨机动误差而进行的中小规模机动。典型地月转移需2-3次TCM，总代价约几十米/秒。
keywords: 轨迹修正机动, Trajectory Correction Manoeuvre, TCM, TCM, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 转移轨道上为修正入轨机动误差而进行的中小规模机动。典型地月转移需2-3次TCM，总代价约几十米/秒。
  image: /logo.png
permalink: /glossary/dynamics/trajectory-correction-manoeuvre-tcm/
---

# 轨迹修正机动（Trajectory Correction Manoeuvre, TCM）
...
转移轨道上为修正入轨机动误差而进行的中小规模机动。典型地月转移需2-3次TCM，总代价约几十米/秒。
