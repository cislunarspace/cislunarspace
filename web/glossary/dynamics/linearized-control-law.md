---
title: 线性化控制律（Linearized Control Law）
description: 基于准Floquet线性化解推导的轨道保持控制律。通过在xy面内或同时在xy面和z方向施加速度增量来消除不稳定分量。该控制律显式且简单，但仅适用于动力学替代轨道附近的小幅值运动。
keywords: 线性化控制律, Linearized Control Law, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 基于准Floquet线性化解推导的轨道保持控制律。通过在xy面内或同时在xy面和z方向施加速度增量来消除不稳定分量。该控制律显式且简单，但仅适用于动力学替代轨道附近的小幅值运动。
  image: /logo.png
permalink: /glossary/dynamics/linearized-control-law/
---

# 线性化控制律（Linearized Control Law）
...
基于准Floquet线性化解推导的轨道保持控制律。通过在xy面内或同时在xy面和z方向施加速度增量来消除不稳定分量。该控制律显式且简单，但仅适用于动力学替代轨道附近的小幅值运动。
