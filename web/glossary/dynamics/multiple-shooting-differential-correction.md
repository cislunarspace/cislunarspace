---
title: 多点射击微分修正（Multiple-Shooting Differential Correction）
description: 将长轨道分成多个片段，通过联立调整所有分段状态来满足约束的修正方法。
keywords: 多点射击微分修正, Multiple-Shooting Differential Correction, 轨道动力学, 轨道优化, 非线性动力学
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 将长轨道分成多个片段，通过联立调整所有分段状态来满足约束的修正方法。
  image: /logo.png
permalink: /glossary/dynamics/multiple-shooting-differential-correction/
---

# 多点射击微分修正（Multiple-Shooting Differential Correction）
...
将长轨道分成多个片段，通过联立调整所有分段状态来满足约束的修正方法。
