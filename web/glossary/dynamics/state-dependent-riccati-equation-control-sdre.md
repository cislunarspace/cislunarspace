---
title: 状态依赖Riccati方程控制（State-Dependent Riccati Equation Control, SDRE）
description: 将非线性系统分解为状态依赖系数矩阵，采用状态依赖代数Riccati方程在线求解反馈控制律的控制方法。可处理状态约束和输入约束，适用于近距离交会的非线性制导。
keywords: 状态依赖Riccati方程控制, State-Dependent Riccati Equation Control, SDRE, SDRE, 轨道动力学, 姿态控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 将非线性系统分解为状态依赖系数矩阵，采用状态依赖代数Riccati方程在线求解反馈控制律的控制方法。可处理状态约束和输入约束，适用于近距离交会的非线性制导。
  image: /logo.png
permalink: /glossary/dynamics/state-dependent-riccati-equation-control-sdre/
---

# 状态依赖Riccati方程控制（State-Dependent Riccati Equation Control, SDRE）
...
将非线性系统分解为状态依赖系数矩阵，采用状态依赖代数Riccati方程在线求解反馈控制律的控制方法。可处理状态约束和输入约束，适用于近距离交会的非线性制导。
