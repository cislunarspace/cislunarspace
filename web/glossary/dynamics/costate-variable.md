---
title: 协态变量（Costate Variable）
description: 最优控制中与状态变量对偶的变量，其动力学由哈密顿函数对状态的偏导确定。
keywords: 协态变量, Costate Variable, , 动力学, 非线性, 稳定性, 流形, 控制
author: 天疆说
date: 2026-07-31
...
wechatShare:
  ...
  image: /logo.png
og:
  title: 协态变量（Costate Variable）详解 | 术语定义
  description: 最优控制中与状态变量对偶的变量，其动力学由哈密顿函数对状态的偏导确定。
  image: /logo.png
  type: article
twitter:
  ...
  description: 最优控制中与状态变量对偶的变量，其动力学由哈密顿函数对状态的偏导确定。
  image: /logo.png
permalink: /glossary/dynamics/costate-variable/
---
...
最优控制中与状态变量对偶的变量，其动力学由哈密顿函数对状态的偏导确定。
