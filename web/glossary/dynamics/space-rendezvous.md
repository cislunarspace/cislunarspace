---
title: 空间交会（Space Rendezvous）
description: 两个航天器在轨道上汇合的过程。
keywords: 空间交会, Space Rendezvous, 轨道动力学, 姿态控制, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 两个航天器在轨道上汇合的过程。
  image: /logo.png
permalink: /glossary/dynamics/space-rendezvous/
---

# 空间交会（Space Rendezvous）
