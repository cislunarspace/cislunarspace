---
title: 测量协方差矩阵（Measurement Covariance Matrix）
description: 表示测量噪声统计特性的矩阵。测量误差协方差越大，滤波器对相应测量的信任程度越低。
keywords: 测量协方差矩阵, Measurement Covariance Matrix, 轨道动力学, 控制理论, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 表示测量噪声统计特性的矩阵。测量误差协方差越大，滤波器对相应测量的信任程度越低。
  image: /logo.png
permalink: /glossary/dynamics/measurement-covariance-matrix/
---

# 测量协方差矩阵（Measurement Covariance Matrix）
...
表示测量噪声统计特性的矩阵。测量误差协方差越大，滤波器对相应测量的信任程度越低。

## 应用价值

测量协方差矩阵在轨道设计和轨迹优化中用于将连续控制问题离散化，通过非线性规划求解最优控制序列。
