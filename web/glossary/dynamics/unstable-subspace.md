---
title: 不稳定子空间（Unstable Subspace）
description: 模大于1的特征值对应的子空间，沿此子空间流动远离平衡点。
keywords: 不稳定子空间, Unstable Subspace, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 模大于1的特征值对应的子空间，沿此子空间流动远离平衡点。
  image: /logo.png
permalink: /glossary/dynamics/unstable-subspace/
---

# 不稳定子空间（Unstable Subspace）
