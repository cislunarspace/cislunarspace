---
title: 太阳辐射压摄动（Solar Radiation Pressure Perturbation, SRP Perturbation）
description: 太阳光子对航天器表面施加动量变化产生的摄动，与表面材料反射特性、暴露面积和姿态相关。
keywords: 太阳辐射压摄动, Solar Radiation Pressure Perturbation, SRP Perturbation, SRP摄动, 轨道动力学, 姿态控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 太阳光子对航天器表面施加动量变化产生的摄动，与表面材料反射特性、暴露面积和姿态相关。
  image: /logo.png
permalink: /glossary/dynamics/solar-radiation-pressure-perturbation-srp-perturbation/
---

# 太阳辐射压摄动（Solar Radiation Pressure Perturbation, SRP Perturbation）
...
太阳光子对航天器表面施加动量变化产生的摄动，与表面材料反射特性、暴露面积和姿态相关。
