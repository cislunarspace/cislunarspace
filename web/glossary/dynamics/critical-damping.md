---
title: 临界阻尼（Critical Damping）
description: 阻尼比等于1的阻尼状态，此时系统收敛到目标状态无振荡，且收敛时间最短。
...
twitter:
  ...
  description: 阻尼比等于1的阻尼状态，此时系统收敛到目标状态无振荡，且收敛时间最短。
  image: /logo.png
permalink: /glossary/dynamics/critical-damping/
---
...
阻尼比等于1的阻尼状态，此时系统收敛到目标状态无振荡，且收敛时间最短。
