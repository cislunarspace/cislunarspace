---
title: 同伦连续法（Homotopy Continuation Method）
description: 通过引入连续参数将原问题与易解问题连接，逐步求解原问题的优化技术。
keywords: 同伦连续法, Homotopy Continuation Method, 轨道优化, 控制理论, 非线性控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 通过引入连续参数将原问题与易解问题连接，逐步求解原问题的优化技术。
  image: /logo.png
permalink: /glossary/dynamics/homotopy-continuation-method/
---

# 同伦连续法（Homotopy Continuation Method）
...
通过引入连续参数将原问题与易解问题连接，逐步求解原问题的优化技术。
