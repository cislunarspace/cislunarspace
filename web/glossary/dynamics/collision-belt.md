---
title: 碰撞带（Collision Belt）
description: 相空间中与月球碰撞的初始条件集合，按Jacobi常数和位置坐标分布。
keywords: 碰撞带, Collision Belt, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 相空间中与月球碰撞的初始条件集合，按Jacobi常数和位置坐标分布。
  image: /logo.png
permalink: /glossary/dynamics/collision-belt/
---
...
相空间中与月球碰撞的初始条件集合，按Jacobi常数和位置坐标分布。
