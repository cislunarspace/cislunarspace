---
title: 伪速率喷气控制（Pseudo-rate Jet Control）
description: 基于姿态偏差和伪速率的喷气章动或进动控制方法。
keywords: 伪速率喷气控制, Pseudo-rate Jet Control, 轨道设计, 最优控制, 动力学建模, 脉冲机动
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 基于姿态偏差和伪速率的喷气章动或进动控制方法。
  image: /logo.png
permalink: /glossary/dynamics/pseudo-rate-jet-control/
---

# 伪速率喷气控制（Pseudo-rate Jet Control）
