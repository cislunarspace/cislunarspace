...
description: 平动点轨道维持控制中的一种控制量寻优策略。利用第n圈控制残差对第n+1圈控制量影响显著、对第n+2圈影响通常超出阈值的特性，仅以单步后的控制量最小为目标进行优化，避免多步预测带来的计算复杂度和累积误差。
...
平动点轨道维持控制中的一种控制量寻优策略。利用第n圈控制残差对第n+1圈控制量影响显著、对第n+2圈影响通常超出阈值的特性，仅以单步后的控制量最小为目标进行优化，避免多步预测带来的计算复杂度和累积误差。
