---
title: 康托尔环面（Cantorus）
description: KAM环面破裂后的残存结构。康托尔环面具有分形结构，是不变环面与混沌海之间的边界，在保守系统中分隔不同动力学区域。
keywords: 康托尔环面, Cantorus, 轨道力学, 姿态控制, 相对运动
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: KAM环面破裂后的残存结构。康托尔环面具有分形结构，是不变环面与混沌海之间的边界，在保守系统中分隔不同动力学区域。
  image: /logo.png
permalink: /glossary/dynamics/cantorus/
---
...
KAM环面破裂后的残存结构。康托尔环面具有分形结构，是不变环面与混沌海之间的边界，在保守系统中分隔不同动力学区域。
