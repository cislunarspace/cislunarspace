---
title: 双自旋航天器（Dual-Spin Spacecraft）
description: 由高速旋转平台和稳定平台组成的大型卫星。
keywords: 双自旋航天器, Dual-Spin Spacecraft, 轨道设计, 最优控制, 动力学建模, 脉冲机动
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 由高速旋转平台和稳定平台组成的大型卫星。
  image: /logo.png
permalink: /glossary/dynamics/dual-spin-spacecraft/
---

# 双自旋航天器（Dual-Spin Spacecraft）
