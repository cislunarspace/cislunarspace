---
title: 滚动率滤波（Roll-off Filtering）
description: 用低通滤波衰减高频模态增益的控制策略，避免控制带宽以上频率的未建模模态被激励，常用双极点低通滤波器或贝塞尔、Butterworth等高阶低通滤波器实现。
keywords: 滚动率滤波, Roll-off Filtering, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 用低通滤波衰减高频模态增益的控制策略，避免控制带宽以上频率的未建模模态被激励，常用双极点低通滤波器或贝塞尔、Butterworth等高阶低通滤波器实现。
  image: /logo.png
permalink: /glossary/dynamics/roll-off-filtering/
---

# 滚动率滤波（Roll-off Filtering）
...
用低通滤波衰减高频模态增益的控制策略，避免控制带宽以上频率的未建模模态被激励，常用双极点低通滤波器或贝塞尔、Butterworth等高阶低通滤波器实现。
