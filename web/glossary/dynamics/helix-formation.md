---
title: 螺旋式编队（Helix Formation）
description: 同时利用偏心率差异和倾角差异产生的复合相对运动，形成在径向-横向平面内不交汇的螺旋状相对轨迹。TanDEM-X任务采用此构型，具有被动碰撞安全性。
keywords: 螺旋式编队, Helix Formation, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 同时利用偏心率差异和倾角差异产生的复合相对运动，形成在径向-横向平面内不交汇的螺旋状相对轨迹。TanDEM-X任务采用此构型，具有被动碰撞安全性。
  image: /logo.png
permalink: /glossary/dynamics/helix-formation/
---
...
同时利用偏心率差异和倾角差异产生的复合相对运动，形成在径向-横向平面内不交汇的螺旋状相对轨迹。TanDEM-X任务采用此构型，具有被动碰撞安全性。
