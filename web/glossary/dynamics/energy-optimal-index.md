---
title: 能量最优指标（Energy Optimal Index）
description: 以脉冲速度矢量二范数平方和为优化指标。
keywords: 能量最优指标, Energy Optimal Index, , 动力学, 非线性, 稳定性, 流形, 控制
author: 天疆说
date: 2026-07-31
...
wechatShare:
  ...
  image: /logo.png
og:
  title: 能量最优指标（Energy Optimal Index）详解 | 术语定义
  description: 以脉冲速度矢量二范数平方和为优化指标。
  image: /logo.png
  type: article
twitter:
  ...
  description: 以脉冲速度矢量二范数平方和为优化指标。
  image: /logo.png
permalink: /glossary/dynamics/energy-optimal-index/
---

# 能量最优指标（Energy Optimal Index）
