...
description: 将周期函数展开为正弦和余弦项级数逼近的方法。本文用于展开Floquet模态矩阵的周期分量，以获得闭合形式的有界相对运动解析解。
keywords: 傅里叶级数展开, Fourier series expansion, 轨道力学, 最优控制, 非线性动力学
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 将周期函数展开为正弦和余弦项级数逼近的方法。本文用于展开Floquet模态矩阵的周期分量，以获得闭合形式的有界相对运动解析解。
  image: /logo.png
permalink: /glossary/dynamics/fourier-series-expansion/
---
...
将周期函数展开为正弦和余弦项级数逼近的方法。本文用于展开Floquet模态矩阵的周期分量，以获得闭合形式的有界相对运动解析解。
