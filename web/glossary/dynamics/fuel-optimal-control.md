...
description: 以推进剂消耗最少为目标的轨道优化目标。等价于最小化速度变化总量或最大化最终质量。
keywords: 燃料最优控制, Fuel-Optimal Control, 轨道力学, 动力学建模, 数值积分
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 以推进剂消耗最少为目标的轨道优化目标。等价于最小化速度变化总量或最大化最终质量。
  image: /logo.png
permalink: /glossary/dynamics/fuel-optimal-control/
---
...
以推进剂消耗最少为目标的轨道优化目标。等价于最小化速度变化总量或最大化最终质量。
