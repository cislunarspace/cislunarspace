...
keywords: 有限状态机, Finite State Machine, FSM, 轨道动力学, 姿态控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 描述事件触发系统在有限状态间转移的数学模型，是模式管理系统的常用设计工具。
  image: /logo.png
permalink: /glossary/dynamics/fsm/
---
...
有限状态机在轨道动力学和姿态控制中具有重要作用，是分析航天器运动特性的重要工具。通过对该概念的研究，可以优化轨道转移方案并提高控制系统的性能。
