---
title: 非过境轨道（Non-transit Orbit）
description: 不穿过瓶颈区域、始终停留在出发 realm 的轨道。
keywords: 非过境轨道, Non-transit Orbit, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 不穿过瓶颈区域、始终停留在出发 realm 的轨道。
  image: /logo.png
permalink: /glossary/dynamics/non-transit-orbit/
---

# 非过境轨道（Non-transit Orbit）
