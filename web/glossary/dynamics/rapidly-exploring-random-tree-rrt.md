---
title: 快速扩展随机树（Rapidly-exploring Random Tree, RRT）
description: 一种增量式采样运动规划算法，通过随机采样逐步构建树结构，能快速探索状态空间并具有渐进最优性。
keywords: 快速扩展随机树, Rapidly-exploring Random Tree, RRT, RRT, 轨道优化, 控制理论
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 一种增量式采样运动规划算法，通过随机采样逐步构建树结构，能快速探索状态空间并具有渐进最优性。
  image: /logo.png
permalink: /glossary/dynamics/rapidly-exploring-random-tree-rrt/
---
...
一种增量式采样运动规划算法，通过随机采样逐步构建树结构，能快速探索状态空间并具有渐进最优性。
