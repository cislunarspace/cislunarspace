...
description: 平均化 Hamiltonian 积分中出现的代数曲线。在圆目标轨道（p_θ=0）的情形，积分化为 genus 2 超椭圆曲线，影响最优控制的结构和数值求解难度。
keywords: 超椭圆曲线, Hyperelliptic Curve, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
平均化 Hamiltonian 积分中出现的代数曲线。在圆目标轨道（p_θ=0）的情形，积分化为 genus 2 超椭圆曲线，影响最优控制的结构和数值求解难度。
