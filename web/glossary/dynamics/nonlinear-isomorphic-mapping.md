---
title: 非线性同构映射（Nonlinear Isomorphic Mapping）
description: 修改轨道根数（MEE）与笛卡尔坐标之间的非线性双射变换。
keywords: 非线性同构映射, Nonlinear Isomorphic Mapping, 轨道动力学, 姿态控制, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 修改轨道根数（MEE）与笛卡尔坐标之间的非线性双射变换。
  image: /logo.png
permalink: /glossary/dynamics/nonlinear-isomorphic-mapping/
---

# 非线性同构映射（Nonlinear Isomorphic Mapping）
