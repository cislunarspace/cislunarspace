---
title: 机动地图（Maneuver Map）
description: 将最优修正机动表示为初始状态偏差的高阶多项式映射，通过偏逆技术构建，可替代耗时的数值积分。
keywords: 机动地图, Maneuver Map, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 将最优修正机动表示为初始状态偏差的高阶多项式映射，通过偏逆技术构建，可替代耗时的数值积分。
  image: /logo.png
permalink: /glossary/dynamics/maneuver-map/
---
...
将最优修正机动表示为初始状态偏差的高阶多项式映射，通过偏逆技术构建，可替代耗时的数值积分。
