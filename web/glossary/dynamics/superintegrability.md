---
title: 超可积性（Superintegrability）
description: 相对轨道运动问题可化为经典开普勒问题的性质。通过适当的变量变换，将非线性相对运动方程降阶为可积的开普勒方程，从而得到闭式解。
keywords: 超可积性, Superintegrability, 轨道动力学, 控制理论, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 相对轨道运动问题可化为经典开普勒问题的性质。通过适当的变量变换，将非线性相对运动方程降阶为可积的开普勒方程，从而得到闭式解。
  image: /logo.png
permalink: /glossary/dynamics/superintegrability/
---
...
相对轨道运动问题可化为经典开普勒问题的性质。通过适当的变量变换，将非线性相对运动方程降阶为可积的开普勒方程，从而得到闭式解。
