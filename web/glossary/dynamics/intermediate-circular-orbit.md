---
title: 中间圆轨道（Intermediate Circular Orbit）
description: 反向积分法中用于分段修正速度的局部圆轨道。由于长时间反向积分受月球引力扰动会偏离近似切向方向，在反向积分每一步到达的端点处计算局部圆轨道速度，用打靶法修正航天器速度使其匹配圆轨道，再以此为新起点继续优化，保证计算的收敛性。
keywords: 中间圆轨道, Intermediate Circular Orbit, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 反向积分法中用于分段修正速度的局部圆轨道。由于长时间反向积分受月球引力扰动会偏离近似切向方向，在反向积分每一步到达的端点处计算局部圆轨道速度，用打靶法修正航天器速度使其匹配圆轨道，再以此为新起点继续优化，保证计算的收敛性。
  image: /logo.png
permalink: /glossary/dynamics/intermediate-circular-orbit/
---

# 中间圆轨道（Intermediate Circular Orbit）
...
反向积分法中用于分段修正速度的局部圆轨道。由于长时间反向积分受月球引力扰动会偏离近似切向方向，在反向积分每一步到达的端点处计算局部圆轨道速度，用打靶法修正航天器速度使其匹配圆轨道，再以此为新起点继续优化，保证计算的收敛性。
