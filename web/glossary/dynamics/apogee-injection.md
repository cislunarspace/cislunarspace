---
title: 远地点射入（Apogee Injection）
description: 在过渡轨道远地点施加脉冲将卫星送入准同步轨道的入轨方式。
keywords: Apogee Injection, 三体问题, 动力学分叉, 轨道力学, 远地点射入
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 在过渡轨道远地点施加脉冲将卫星送入准同步轨道的入轨方式。
  image: /logo.png
permalink: /glossary/dynamics/apogee-injection/
---

# 远地点射入（Apogee Injection）
