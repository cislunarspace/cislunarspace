---
title: 惯性（Inertia）
description: 聚类中各成员到其所属簇质心欧氏距离平方和，用于评估聚类紧密度。
keywords: 惯性, Inertia, 轨道动力学, 控制理论, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 聚类中各成员到其所属簇质心欧氏距离平方和，用于评估聚类紧密度。
  image: /logo.png
permalink: /glossary/dynamics/inertia/
---
...
聚类中各成员到其所属簇质心欧氏距离平方和，用于评估聚类紧密度。

## 应用价值

惯性在轨道设计和轨迹优化中用于将连续控制问题离散化，通过非线性规划求解最优控制序列。
