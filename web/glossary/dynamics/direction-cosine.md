---
title: 方向余弦（Direction Cosine）
description: 推力矢量在各坐标轴上的投影系数，由协态变量的归一化比值确定。方向余弦将最优控制问题中的协态变量转化为推力矢量的物理方向。
keywords: 方向余弦, Direction Cosine, 轨道动力学, 姿态控制, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 推力矢量在各坐标轴上的投影系数，由协态变量的归一化比值确定。方向余弦将最优控制问题中的协态变量转化为推力矢量的物理方向。
  image: /logo.png
permalink: /glossary/dynamics/direction-cosine/
---
...
>
> 本文来源：Kluever and Pierson, 1997, Optimal Earth-Moon Trajectories Using Nuclear Electric Propulsion
>
> 站地址：[https://cislunarspace.cn](https://cislunarspace.cn)

## 定义

推力矢量在各坐标轴上的投影系数，由协态变量的归一化比值确定。方向余弦将最优控制问题中的协态变量转化为推力矢量的物理方向。
