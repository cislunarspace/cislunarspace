---
title: Edelbaum方法（Edelbaum Method）
description: 由 Edelbaum 提出的低推力轨道转移解析近似方法，假设连续切向推力、无摄动条件下，将螺旋转移简化为半长轴和轨道倾角的耦合变化。常用于快速估算低推力升轨或降轨所需的总速度增量和飞行时间。
keywords: Edelbaum方法, Edelbaum Method, 轨道优化, 控制理论, 非线性控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 由 Edelbaum 提出的低推力轨道转移解析近似方法，假设连续切向推力、无摄动条件下，将螺旋转移简化为半长轴和轨道倾角的耦合变化。常用于快速估算低推力升轨或降轨所需的总速度增量和飞行时间。
  image: /logo.png
permalink: /glossary/dynamics/edelbaum-method/
---

# Edelbaum方法（Edelbaum Method）
...
由 Edelbaum 提出的低推力轨道转移解析近似方法，假设连续切向推力、无摄动条件下，将螺旋转移简化为半长轴和轨道倾角的耦合变化。常用于快速估算低推力升轨或降轨所需的总速度增量和飞行时间。
