---
title: 线性TPA（Linear TPA）
description: 基于状态转移矩阵线性近似计算修正机动的靶点法，在大初始偏差时精度不足。
keywords: 线性TPA, Linear TPA, Lin. TPA, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 基于状态转移矩阵线性近似计算修正机动的靶点法，在大初始偏差时精度不足。
  image: /logo.png
permalink: /glossary/dynamics/linear-tpa/
---
...
基于状态转移矩阵线性近似计算修正机动的靶点法，在大初始偏差时精度不足。
