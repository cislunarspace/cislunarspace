---
title: λ参数（Lambda Parameter, λ）
description: λ = |r|V²/μ，是动能两倍与势能之比的无量纲量，决定轨道类型：λ < 2 为椭圆，λ > 2 为双曲，λ = 2 为抛物线。
keywords: λ参数, Lambda Parameter, λ, λ, 轨道力学, 姿态控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: λ = |r|V²/μ，是动能两倍与势能之比的无量纲量，决定轨道类型：λ < 2 为椭圆，λ > 2 为双曲，λ = 2 为抛物线。
  image: /logo.png
permalink: /glossary/dynamics/lambda-parameter/
---

# λ参数（Lambda Parameter, λ）
...
λ = |r|V²/μ，是动能两倍与势能之比的无量纲量，决定轨道类型：λ < 2 为椭圆，λ > 2 为双曲，λ = 2 为抛物线。
