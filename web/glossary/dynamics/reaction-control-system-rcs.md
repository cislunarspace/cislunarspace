---
title: 姿态控制系统（Reaction Control System, RCS）
description: 通过喷气产生反作用力矩来控制航天器姿态的系统。论文中假设16个10 N推力器分布在追踪星边缘，用于姿态机动和位置控制。
keywords: 姿态控制系统, Reaction Control System, RCS, RCS, 轨道动力学, 姿态控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 通过喷气产生反作用力矩来控制航天器姿态的系统。论文中假设16个10 N推力器分布在追踪星边缘，用于姿态机动和位置控制。
  image: /logo.png
permalink: /glossary/dynamics/reaction-control-system-rcs/
---

# 姿态控制系统（Reaction Control System, RCS）

> 本文作者：[天疆说](https://blog.csdn.net/qq_33254264)
>
> 本文来源：Bucchioni和Innocenti - 2021 - Rendezvous in Cis-Lunar Space near Rectilinear Halo Orbit Dynamics and Control Issues
>
> 站地址：[https://cislunarspace.cn](https://cislunarspace.cn)

## 定义

通过喷气产生反作用力矩来控制航天器姿态的系统。论文中假设16个10 N推力器分布在追踪星边缘，用于姿态机动和位置控制。
