---
title: 交叉算子（Crossover Operator）
description: 微分进化算法中，将目标向量与变异向量按一定概率混合生成试验向量的操作。交叉概率CR是算法的关键参数之一。
keywords: 交叉算子, Crossover Operator, CR, 轨道优化, 控制理论
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 微分进化算法中，将目标向量与变异向量按一定概率混合生成试验向量的操作。交叉概率CR是算法的关键参数之一。
  image: /logo.png
permalink: /glossary/dynamics/crossover-operator/
---
...
微分进化算法中，将目标向量与变异向量按一定概率混合生成试验向量的操作。交叉概率CR是算法的关键参数之一。
