---
title: 轨道注入误差（Orbit Injection Error）
description: 轨道注入时产生的初始位置和速度偏差，用零均值高斯分布建模。
keywords: 轨道注入误差, Orbit Injection Error, OI error, dynamics
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 轨道注入时产生的初始位置和速度偏差，用零均值高斯分布建模。
  image: /logo.png
permalink: /glossary/dynamics/OI-error/
---
