---
title: 勒让德级数展开（Legendre Series Expansion）
description: 将势函数展开为勒让德多项式级数，用于推导高阶相对运动模型。
keywords: 勒让德级数展开, Legendre Series Expansion, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 将势函数展开为勒让德多项式级数，用于推导高阶相对运动模型。
  image: /logo.png
permalink: /glossary/dynamics/legendre-series-expansion/
---
