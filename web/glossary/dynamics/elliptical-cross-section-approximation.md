---
title: 椭圆截面近似（Elliptical Cross Section Approximation）
description: 将非各向同性高斯分布的误差椭圆近似为圆的方法，是计算碰撞概率的关键步骤。
...
twitter:
  ...
  description: 将非各向同性高斯分布的误差椭圆近似为圆的方法，是计算碰撞概率的关键步骤。
  image: /logo.png
permalink: /glossary/dynamics/elliptical-cross-section-approximation/
---

# 椭圆截面近似（Elliptical Cross Section Approximation）
...
将非各向同性高斯分布的误差椭圆近似为圆的方法，是计算碰撞概率的关键步骤。
