---
title: 模态溢出（Modal Overflow）
description: 挠性附件模态通过姿态控制系统耦合导致姿态抖动或发散的现象。
keywords: 模态溢出, Modal Overflow, 轨道优化, 控制理论, 非线性控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 挠性附件模态通过姿态控制系统耦合导致姿态抖动或发散的现象。
  image: /logo.png
permalink: /glossary/dynamics/modal-overflow/
---
