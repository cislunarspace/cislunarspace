...
description: 月球表面上直接上升转移轨迹不存在的区域。Penzo在1961年发现在月面经度约270度附近存在这样的限制区。本研究进一步表明，该区域会随雅可比常数变化而移动，且在加入太阳摄动后限制区边界变得更加模糊。
keywords: 限制区, Restricted Region, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
月球表面上直接上升转移轨迹不存在的区域。Penzo在1961年发现在月面经度约270度附近存在这样的限制区。本研究进一步表明，该区域会随雅可比常数变化而移动，且在加入太阳摄动后限制区边界变得更加模糊。
