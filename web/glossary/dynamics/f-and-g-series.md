---
title: f和g级数（f and g Series）
description: 由已知时刻的位置速度推求后续时刻位置速度的泰勒级数展开式。
keywords: f和g级数, f and g Series, 轨道动力学, 姿态控制, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 由已知时刻的位置速度推求后续时刻位置速度的泰勒级数展开式。
  image: /logo.png
permalink: /glossary/dynamics/f-and-g-series/
---

# f和g级数（f and g Series）

> 本文作者：[天疆说](https://blog.csdn.net/qq_33254264)
>
> 本文来源：肖峰 - 1989 - 球面天文学与天体力学基础
>
> 站地址：[https://cislunarspace.cn](https://cislunarspace.cn)

## 定义

由已知时刻的位置速度推求后续时刻位置速度的泰勒级数展开式。
