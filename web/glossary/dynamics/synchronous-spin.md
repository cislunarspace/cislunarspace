---
title: 同步自转（Synchronous Spin）
description: 天体自转周期与轨道周期相等的状态，导致始终以同一面对着被绕天体，是潮汐演化的终态之一。
keywords: 同步自转, Synchronous Spin, , 动力学, 非线性, 稳定性, 流形, 控制
author: 天疆说
date: 2026-07-31
...
wechatShare:
  ...
  image: /logo.png
og:
  title: 同步自转（Synchronous Spin）详解 | 术语定义
  description: 天体自转周期与轨道周期相等的状态，导致始终以同一面对着被绕天体，是潮汐演化的终态之一。
  image: /logo.png
  type: article
twitter:
  ...
  description: 天体自转周期与轨道周期相等的状态，导致始终以同一面对着被绕天体，是潮汐演化的终态之一。
  image: /logo.png
permalink: /glossary/dynamics/synchronous-spin/
---

# 同步自转（Synchronous Spin）
...
天体自转周期与轨道周期相等的状态，导致始终以同一面对着被绕天体，是潮汐演化的终态之一。
