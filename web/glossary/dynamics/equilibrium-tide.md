---
title: 平衡潮（Equilibrium Tide）
description: 理想流体行星在外部天体潮汐力作用下的静态形变产生的平衡形状，是计算实际潮汐响应的基准模型。
keywords: 平衡潮, Equilibrium Tide, 轨道优化, 控制理论, 非线性控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 理想流体行星在外部天体潮汐力作用下的静态形变产生的平衡形状，是计算实际潮汐响应的基准模型。
  image: /logo.png
permalink: /glossary/dynamics/equilibrium-tide/
---
...
理想流体行星在外部天体潮汐力作用下的静态形变产生的平衡形状，是计算实际潮汐响应的基准模型。
...
- Murray & Dermott 1999, Sect. 4.2, 4.4
