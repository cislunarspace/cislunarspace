---
title: 弱稳定边界（Weak Stability Boundary）
description: 太阳、地球、月球引力平衡区域的边界，在此区域内可实现弹道捕获。
keywords: 弱稳定边界, Weak Stability Boundary, WSB, 轨道动力学, 控制理论, 数值仿真
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 太阳、地球、月球引力平衡区域的边界，在此区域内可实现弹道捕获。
  image: /logo.png
permalink: /glossary/dynamics/weak-stability-boundary/
---
...
太阳、地球、月球引力平衡区域的边界，在此区域内可实现弹道捕获。

## 应用价值

弱稳定边界涉及地月空间航天器的运动特性分析和控制问题。在实际任务设计中，利用该方法可以分析轨道稳定性、计算控制策略，或评估摄动因素对轨道的影响，为任务安全性和可靠性提供保障。
