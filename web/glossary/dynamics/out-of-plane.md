---
title: 轨道外分量（Out-of-Plane）
description: 垂直于参考轨道面的运动分量。
keywords: 轨道外分量, Out-of-Plane, 动力学, 控制, 优化, 稳定性分析
author: 天疆说
date: 2026-07-31
...
wechatShare:
  ...
  image: /logo.png
og:
  title: 轨道外分量（Out-of-Plane）详解 | 术语定义
  description: 垂直于参考轨道面的运动分量。
  image: /logo.png
  type: article
twitter:
  ...
  description: 垂直于参考轨道面的运动分量。
  image: /logo.png
permalink: /glossary/dynamics/out-of-plane/
---
