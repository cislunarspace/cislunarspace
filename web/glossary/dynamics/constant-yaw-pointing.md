---
title: 等偏航角指向（Constant Yaw Pointing）
description: 保持推力方向相对轨道坐标偏航角恒定的指向模式。
keywords: 等偏航角指向, Constant Yaw Pointing, 轨道动力学, 控制理论, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 保持推力方向相对轨道坐标偏航角恒定的指向模式。
  image: /logo.png
permalink: /glossary/dynamics/constant-yaw-pointing/
---

# 等偏航角指向（Constant Yaw Pointing）
...
保持推力方向相对轨道坐标偏航角恒定的指向模式。

## 应用价值

等偏航角指向在轨道设计和轨迹优化中用于将连续控制问题离散化，通过非线性规划求解最优控制序列。
