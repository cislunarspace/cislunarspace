---
title: 低推力禁区（Low-Thrust Forbidden Region）
description: 低推力运动被约束在特定低推力哈密顿量值的边界内，与天然CR3BP的禁区类似，为转移提供最小能量约束。
keywords: 低推力禁区, Low-Thrust Forbidden Region, 轨道动力学, 轨道优化, 非线性动力学
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 低推力运动被约束在特定低推力哈密顿量值的边界内，与天然CR3BP的禁区类似，为转移提供最小能量约束。
  image: /logo.png
permalink: /glossary/dynamics/low-thrust-forbidden-region/
---

# 低推力禁区（Low-Thrust Forbidden Region）
...
低推力运动被约束在特定低推力哈密顿量值的边界内，与天然CR3BP的禁区类似，为转移提供最小能量约束。
