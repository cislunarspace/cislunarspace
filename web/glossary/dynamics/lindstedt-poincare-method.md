...
description: 求解非线性周期系统近共振解的摄动方法。
keywords: Lindstedt-Poincare法, Lindstedt-Poincare Method, , 动力学, 非线性, 稳定性, 流形, 控制
author: 天疆说
date: 2026-07-31
...
wechatShare:
  ...
  image: /logo.png
og:
  title: Lindstedt-Poincare法（Lindstedt-Poincare Method）详解 | 术语定义
  description: 求解非线性周期系统近共振解的摄动方法。
  image: /logo.png
  type: article
twitter:
  ...
  description: 求解非线性周期系统近共振解的摄动方法。
  image: /logo.png
permalink: /glossary/dynamics/lindstedt-poincare-method/
---
