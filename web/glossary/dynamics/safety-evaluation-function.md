---
title: 安全评估函数（Safety Evaluation Function）
description: 当视场内所有子区均不满足安全约束时，通过加权求和高程方差、坡度和粗糙度的归一化值来评估各子区的安全性，值最小的子区为最优着陆点。
keywords: 安全评估函数, Safety Evaluation Function, 轨道优化, 控制理论, 非线性控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 当视场内所有子区均不满足安全约束时，通过加权求和高程方差、坡度和粗糙度的归一化值来评估各子区的安全性，值最小的子区为最优着陆点。
  image: /logo.png
permalink: /glossary/dynamics/safety-evaluation-function/
---

# 安全评估函数（Safety Evaluation Function）
...
当视场内所有子区均不满足安全约束时，通过加权求和高程方差、坡度和粗糙度的归一化值来评估各子区的安全性，值最小的子区为最优着陆点。
