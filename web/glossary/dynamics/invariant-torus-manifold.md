---
title: 不变环面流形（Invariant Torus Manifold）
description: 双圆四体问题中不变环面的稳定或不稳定流形。在地月系侧，不变环面流形与圆型限制性三体问题中平动点轨道的流形形状相似，可通过不变曲线上状态转移矩阵的特征值和特征向量直接确定。该流形是从限制性三体问题结果出发延拓四体模型流形的基础。
keywords: 不变环面流形, Invariant Torus Manifold, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 双圆四体问题中不变环面的稳定或不稳定流形。在地月系侧，不变环面流形与圆型限制性三体问题中平动点轨道的流形形状相似，可通过不变曲线上状态转移矩阵的特征值和特征向量直接确定。该流形是从限制性三体问题结果出发延拓四体模型流形的基础。
  image: /logo.png
permalink: /glossary/dynamics/invariant-torus-manifold/
---

# 不变环面流形（Invariant Torus Manifold）
...
双圆四体问题中不变环面的稳定或不稳定流形。在地月系侧，不变环面流形与圆型限制性三体问题中平动点轨道的流形形状相似，可通过不变曲线上状态转移矩阵的特征值和特征向量直接确定。该流形是从限制性三体问题结果出发延拓四体模型流形的基础。
