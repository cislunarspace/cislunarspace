---
title: 尼霍罗舍夫估计（Nekhorosev Estimates）
description: 给出近可积哈密顿系统能量面附近轨道保持时间下界的指数型估计，揭示小扰动下稳定性的慢衰减特性。
keywords: 尼霍罗舍夫估计, Nekhorosev Estimates, , 动力学, 非线性, 稳定性, 流形, 控制
author: 天疆说
date: 2026-07-31
...
wechatShare:
  ...
  image: /logo.png
og:
  title: 尼霍罗舍夫估计（Nekhorosev Estimates）详解 | 术语定义
  description: 给出近可积哈密顿系统能量面附近轨道保持时间下界的指数型估计，揭示小扰动下稳定性的慢衰减特性。
  image: /logo.png
  type: article
twitter:
  ...
  description: 给出近可积哈密顿系统能量面附近轨道保持时间下界的指数型估计，揭示小扰动下稳定性的慢衰减特性。
  image: /logo.png
permalink: /glossary/dynamics/nekhorosev-estimates/
---
...
给出近可积哈密顿系统能量面附近轨道保持时间下界的指数型估计，揭示小扰动下稳定性的慢衰减特性。
