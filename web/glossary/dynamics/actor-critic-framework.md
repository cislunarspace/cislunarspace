---
title: 演员-评论家框架（Actor-Critic Framework）
description: 强化学习中结合策略梯度与值函数估计的框架，演员网络负责策略输出，评论家网络估计状态值函数以降低方差。
keywords: 演员-评论家框架, Actor-Critic Framework, 轨道优化, 控制理论, 非线性控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 强化学习中结合策略梯度与值函数估计的框架，演员网络负责策略输出，评论家网络估计状态值函数以降低方差。
  image: /logo.png
permalink: /glossary/dynamics/actor-critic-framework/
---
...
强化学习中结合策略梯度与值函数估计的框架，演员网络负责策略输出，评论家网络估计状态值函数以降低方差。
