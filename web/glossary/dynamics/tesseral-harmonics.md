---
title: 田形谐函数（Tesseral Harmonics）
description: 描述引力势随纬度和经度变化、沿纬度和经度都有正负交替的谐函数项
keywords: 田形谐函数, Tesseral Harmonics, 轨道力学, 最优控制, 轨迹优化
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 描述引力势随纬度和经度变化、沿纬度和经度都有正负交替的谐函数项
  image: /logo.png
permalink: /glossary/dynamics/tesseral-harmonics/
---

# 田形谐函数（Tesseral Harmonics）
...
描述引力势随纬度和经度变化、沿纬度和经度都有正负交替的谐函数项
