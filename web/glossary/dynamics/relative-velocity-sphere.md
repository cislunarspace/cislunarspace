---
title: 相对速度球（Relative Velocity Sphere）
description: 用于分析不同初始相对速度大小和方向下交会对接成功率的工具，将速度方向映射到单位球面上的点。
keywords: 相对速度球, Relative Velocity Sphere, , 动力学, 非线性, 稳定性, 流形, 控制
author: 天疆说
date: 2026-07-31
...
wechatShare:
  ...
  image: /logo.png
og:
  title: 相对速度球（Relative Velocity Sphere）详解 | 术语定义
  description: 用于分析不同初始相对速度大小和方向下交会对接成功率的工具，将速度方向映射到单位球面上的点。
  image: /logo.png
  type: article
twitter:
  ...
  description: 用于分析不同初始相对速度大小和方向下交会对接成功率的工具，将速度方向映射到单位球面上的点。
  image: /logo.png
permalink: /glossary/dynamics/relative-velocity-sphere/
---

# 相对速度球（Relative Velocity Sphere）
...
用于分析不同初始相对速度大小和方向下交会对接成功率的工具，将速度方向映射到单位球面上的点。
