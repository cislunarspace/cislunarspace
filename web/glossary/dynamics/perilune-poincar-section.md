---
title: 近月点庞加莱截面（Perilune Poincaré Section）
description: 转移轨道近月点交于投影面的截面，用于分析地月转移阶段特性和借月飞行参数分布。
keywords: 近月点庞加莱截面, Perilune Poincaré Section, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 转移轨道近月点交于投影面的截面，用于分析地月转移阶段特性和借月飞行参数分布。
  image: /logo.png
permalink: /glossary/dynamics/perilune-poincar-section/
---

# 近月点庞加莱截面（Perilune Poincaré Section）
...
转移轨道近月点交于投影面的截面，用于分析地月转移阶段特性和借月飞行参数分布。
