---
title: 碰撞横截面积半径（Collision Cross-sectional Radius）
description: 主次两物体半径之和定义的碰撞球半径。
keywords: 碰撞横截面积半径, Collision Cross-sectional Radius, rA, 轨道动力学, 姿态控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 主次两物体半径之和定义的碰撞球半径。
  image: /logo.png
permalink: /glossary/dynamics/ra/
---

# 碰撞横截面积半径（Collision Cross-sectional Radius）
...
碰撞横截面积半径在轨道动力学和姿态控制中具有重要作用，是分析航天器运动特性的重要工具。通过对该概念的研究，可以优化轨道转移方案并提高控制系统的性能。
