---
title: 变时间打靶（Variable-Time Shooting）
description: 允许飞行时间作为自由变量参与迭代修正的打靶方法。
keywords: 变时间打靶, Variable-Time Shooting, 轨道设计, 最优控制, 动力学建模, 脉冲机动
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 允许飞行时间作为自由变量参与迭代修正的打靶方法。
  image: /logo.png
permalink: /glossary/dynamics/variable-time-shooting/
---

# 变时间打靶（Variable-Time Shooting）
...
允许飞行时间作为自由变量参与迭代修正的打靶方法。

## 应用价值

在任务规划阶段用于评估不同推进方案的优劣 该概念为地月空间任务设计提供了重要的理论基础 在实际工程中可用于轨道设计、任务规划或控制系统分析。
