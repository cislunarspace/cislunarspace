---
title: 扩展状态（Extended State）
description: 在相对轨道姿态控制系统中，将相对位置与相对速度（或相对姿态与角速度）线性组合构成的增广状态量，用于规定性能控制器的设计。
keywords: 扩展状态, Extended State, 轨道动力学, 三体问题, 平动点
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 在相对轨道姿态控制系统中，将相对位置与相对速度（或相对姿态与角速度）线性组合构成的增广状态量，用于规定性能控制器的设计。
  image: /logo.png
permalink: /glossary/dynamics/extended-state/
---
...
在相对轨道姿态控制系统中，将相对位置与相对速度（或相对姿态与角速度）线性组合构成的增广状态量，用于规定性能控制器的设计。

## 应用价值

扩展状态在地月空间动力学分析和任务轨道设计中具有应用价值。正确理解和应用扩展状态有助于优化轨道设计、控制策略和任务规划，是地月空间任务工程师需要掌握的基础知识。
