---
title: 内部稳定流形（Interior Stable Manifold）
description: 晕轨道稳定流形中朝向月球方向延伸的一半。内部稳定流形上的航天器从晕轨道出发后向月球方向运动，可用于设计经过月球附近的内部转移方案。
keywords: 内部稳定流形, Interior Stable Manifold, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 晕轨道稳定流形中朝向月球方向延伸的一半。内部稳定流形上的航天器从晕轨道出发后向月球方向运动，可用于设计经过月球附近的内部转移方案。
  image: /logo.png
permalink: /glossary/dynamics/interior-stable-manifold/
---

# 内部稳定流形（Interior Stable Manifold）
...
晕轨道稳定流形中朝向月球方向延伸的一半。内部稳定流形上的航天器从晕轨道出发后向月球方向运动，可用于设计经过月球附近的内部转移方案。
