---
title: 收敛速率（Convergence Rate）
description: 系统状态向平衡点或目标状态收敛的速度，通常用指数衰减率或时间常数描述。
keywords: 收敛速率, Convergence Rate, 轨道动力学, 三体问题, 平动点
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 系统状态向平衡点或目标状态收敛的速度，通常用指数衰减率或时间常数描述。
  image: /logo.png
permalink: /glossary/dynamics/convergence-rate/
---
...
系统状态向平衡点或目标状态收敛的速度，通常用指数衰减率或时间常数描述。

## 应用价值

收敛速率在地月空间动力学分析和任务轨道设计中具有应用价值。正确理解和应用收敛速率有助于优化轨道设计、控制策略和任务规划，是地月空间任务工程师需要掌握的基础知识。
