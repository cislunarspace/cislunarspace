---
title: 零运动激励（Null Motion Excitation）
description: 通过在零空间中的运动来激发系统参数而不改变期望姿态的控制策略
keywords: 零运动激励, Null Motion Excitation, 轨道动力学, 三体问题, 平动点
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 通过在零空间中的运动来激发系统参数而不改变期望姿态的控制策略
  image: /logo.png
permalink: /glossary/dynamics/null-motion-excitation/
---

# 零运动激励（Null Motion Excitation）
...
通过在零空间中的运动来激发系统参数而不改变期望姿态的控制策略
