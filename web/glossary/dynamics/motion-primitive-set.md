---
title: 轨迹基元集（Motion Primitive Set）
description: 从大量轨迹中通过聚类提取的有限个代表轨迹集合，支持复杂轨迹初猜构建。
keywords: 轨迹基元集, Motion Primitive Set, 轨道动力学, 控制理论, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 从大量轨迹中通过聚类提取的有限个代表轨迹集合，支持复杂轨迹初猜构建。
  image: /logo.png
permalink: /glossary/dynamics/motion-primitive-set/
---

# 轨迹基元集（Motion Primitive Set）
...
从大量轨迹中通过聚类提取的有限个代表轨迹集合，支持复杂轨迹初猜构建。
