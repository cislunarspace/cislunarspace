---
title: 有限燃烧脉冲（Finite-Burn Pulse）
description: 用固定时长脉冲模拟推力器工作的控制输入模型。
keywords: 有限燃烧脉冲, Finite-Burn Pulse, FBP, 轨道动力学, 姿态控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 用固定时长脉冲模拟推力器工作的控制输入模型。
  image: /logo.png
permalink: /glossary/dynamics/finite-burn-pulse/
---

# 有限燃烧脉冲（Finite-Burn Pulse）
