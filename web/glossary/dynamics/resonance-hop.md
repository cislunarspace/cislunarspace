---
title: 共振跳转（Resonance Hop）
description: SMART-1类低能量转移的核心机动策略。航天器每次飞越L₁颈部区域时，轨道从一个近共振状态跳转到另一个近共振状态，逐步降低能量，最终进入月球引力范围。本质上是三体动力学中混沌效应的工程利用。
keywords: 共振跳转, Resonance Hop, 轨道优化, 控制理论, 非线性控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: SMART-1类低能量转移的核心机动策略。航天器每次飞越L₁颈部区域时，轨道从一个近共振状态跳转到另一个近共振状态，逐步降低能量，最终进入月球引力范围。本质上是三体动力学中混沌效应的工程利用。
  image: /logo.png
permalink: /glossary/dynamics/resonance-hop/
---
...
SMART-1类低能量转移的核心机动策略。航天器每次飞越L₁颈部区域时，轨道从一个近共振状态跳转到另一个近共振状态，逐步降低能量，最终进入月球引力范围。本质上是三体动力学中混沌效应的工程利用。
