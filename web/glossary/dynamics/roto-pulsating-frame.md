---
title: 旋 pulsar 框架（Roto-pulsating Frame）
description: 与旋 pulsating坐标系同义，见该条。
keywords: 旋 pulsar 框架, Roto-pulsating Frame, 轨道动力学, 控制理论, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 与旋 pulsating坐标系同义，见该条。
  image: /logo.png
permalink: /glossary/dynamics/roto-pulsating-frame/
---

# 旋 pulsar 框架（Roto-pulsating Frame）
...
与旋 pulsating坐标系同义，见该条。

## 应用价值

旋 pulsar 框架在轨道设计和轨迹优化中用于将连续控制问题离散化，通过非线性规划求解最优控制序列。
