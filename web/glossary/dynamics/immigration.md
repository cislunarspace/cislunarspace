---
title: 移民策略（Immigration）
description: 遗传算法中当最优解停滞多代时，用随机生成的个体替换部分低分个体的策略。
keywords: 移民策略, Immigration, 轨道动力学, 姿态控制, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 遗传算法中当最优解停滞多代时，用随机生成的个体替换部分低分个体的策略。
  image: /logo.png
permalink: /glossary/dynamics/immigration/
---
...
>
> 本文来源：Waldecker & Howell 2025
>
> 站地址：[https://cislunarspace.cn](https://cislunarspace.cn)

## 定义

遗传算法中当最优解停滞多代时，用随机生成的个体替换部分低分个体的策略。
