...
keywords: 比角动量, Specific Angular Momentum, h, 轨道动力学, 姿态控制
author: 天疆说
date: 2026-07-31
...
比角动量在轨道动力学和姿态控制中具有重要作用，是分析航天器运动特性的重要工具。通过对该概念的研究，可以优化轨道转移方案并提高控制系统的性能。
