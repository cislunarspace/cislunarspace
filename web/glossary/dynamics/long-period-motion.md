---
title: 长周期运动（Long-period Motion）
description: 三角平动点附近相对运动的一种模态，周期约为458天，椭圆轴比约为16/3。通过选取特定初始速度条件可滤除短周期分量而得到纯长周期相对运动，适合编队设计。
keywords: 长周期运动, Long-period Motion, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
三角平动点附近相对运动的一种模态，周期约为458天，椭圆轴比约为16/3。通过选取特定初始速度条件可滤除短周期分量而得到纯长周期相对运动，适合编队设计。
