---
title: 收敛准则（Convergence Criterion）
description: 迭代算法终止判据，通常基于目标函数值变化或约束违反量是否低于预设阈值。
keywords: 收敛准则, Convergence Criterion, , 动力学, 非线性, 稳定性, 流形, 控制
author: 天疆说
date: 2026-07-31
...
wechatShare:
  ...
  image: /logo.png
og:
  title: 收敛准则（Convergence Criterion）详解 | 术语定义
  description: 迭代算法终止判据，通常基于目标函数值变化或约束违反量是否低于预设阈值。
  image: /logo.png
  type: article
twitter:
  ...
  description: 迭代算法终止判据，通常基于目标函数值变化或约束违反量是否低于预设阈值。
  image: /logo.png
permalink: /glossary/dynamics/convergence-criterion/
---
...
迭代算法终止判据，通常基于目标函数值变化或约束违反量是否低于预设阈值。
