---
title: 最优多脉冲机动（Optimal Multi-Impulse, Opt-MI）
description: 以总冲量l¹范数为燃料消耗指标，通过线性规划同时优化N次脉冲的施加时刻和幅值的策略。
keywords: 最优多脉冲机动, Optimal Multi-Impulse, Opt-MI, Opt-MI, 轨道力学, 动力学, 控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 以总冲量l¹范数为燃料消耗指标，通过线性规划同时优化N次脉冲的施加时刻和幅值的策略。
  image: /logo.png
permalink: /glossary/dynamics/opt-mi/
---

# 最优多脉冲机动（Optimal Multi-Impulse, Opt-MI）
...
以总冲量l¹范数为燃料消耗指标，通过线性规划同时优化N次脉冲的施加时刻和幅值的策略。

## 应用价值

该机动方式在地月转移和轨道调整任务中起重要作用，影响任务能量消耗与飞行时间。
