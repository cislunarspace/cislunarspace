---
title: 流形入轨（Manifold Insertion）
description: 航天器从平动点附近周期轨道转入不变流形的过程。流形入轨后，航天器可沿自然动力学路径低能量地离开平动点区域。
keywords: 流形入轨, Manifold Insertion, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 航天器从平动点附近周期轨道转入不变流形的过程。流形入轨后，航天器可沿自然动力学路径低能量地离开平动点区域。
  image: /logo.png
permalink: /glossary/dynamics/manifold-insertion/
---

# 流形入轨（Manifold Insertion）
...
航天器从平动点附近周期轨道转入不变流形的过程。流形入轨后，航天器可沿自然动力学路径低能量地离开平动点区域。
