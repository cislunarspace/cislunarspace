---
title: 容积卡尔曼滤波器（Cubature Kalman Filter）
description: 基于球面-容积规则的sigma点卡尔曼滤波器
keywords: 容积卡尔曼滤波器, Cubature Kalman Filter, CKF, 轨道动力学, 姿态控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 基于球面-容积规则的sigma点卡尔曼滤波器
  image: /logo.png
permalink: /glossary/dynamics/ckf/
---
...
基于球面-容积规则的sigma点卡尔曼滤波器

## 应用价值

容积卡尔曼滤波器在轨道动力学和姿态控制中具有重要作用，是分析航天器运动特性的重要工具。通过对该概念的研究，可以优化轨道转移方案并提高控制系统的性能。
