---
title: 相对运动方程（Relative Motion Equation）
description: 描述一个物体相对于另一个物体运动的微分方程。
keywords: 相对运动方程, Relative Motion Equation, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 描述一个物体相对于另一个物体运动的微分方程。
  image: /logo.png
permalink: /glossary/dynamics/relative-motion-equation/
---
