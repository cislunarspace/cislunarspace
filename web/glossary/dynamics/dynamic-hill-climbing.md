---
title: 动力学爬山（Dynamic Hill-Climbing）
description: 即最速下降法，通过动态调整搜索步长来精化局部最优解的数值优化方法。论文用它对遗传算法找到的候选解进行精细化，直到速度增量变化小于10^-5或时间变化小于4秒为止。
keywords: 动力学爬山, Dynamic Hill-Climbing, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 即最速下降法，通过动态调整搜索步长来精化局部最优解的数值优化方法。论文用它对遗传算法找到的候选解进行精细化，直到速度增量变化小于10^-5或时间变化小于4秒为止。
  image: /logo.png
permalink: /glossary/dynamics/dynamic-hill-climbing/
---

# 动力学爬山（Dynamic Hill-Climbing）
...
即最速下降法，通过动态调整搜索步长来精化局部最优解的数值优化方法。论文用它对遗传算法找到的候选解进行精细化，直到速度增量变化小于10^-5或时间变化小于4秒为止。
