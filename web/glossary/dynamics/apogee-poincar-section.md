---
title: 远地点庞加莱截面（Apogee Poincaré Section）
description: 以太阳为参考的旋转坐标系下，转移轨道远地点与投影圆的交点构成的截面，用于分析地月空间外的转移阶段。
keywords: 远地点庞加莱截面, Apogee Poincaré Section, 轨道力学, 动力学建模, 数值积分
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 以太阳为参考的旋转坐标系下，转移轨道远地点与投影圆的交点构成的截面，用于分析地月空间外的转移阶段。
  image: /logo.png
permalink: /glossary/dynamics/apogee-poincar-section/
---

# 远地点庞加莱截面（Apogee Poincaré Section）
...
以太阳为参考的旋转坐标系下，转移轨道远地点与投影圆的交点构成的截面，用于分析地月空间外的转移阶段。

## 应用价值

平动点附近独特的动力学环境为地月空间任务提供了特殊的轨道选择。
