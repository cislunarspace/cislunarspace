---
title: 平均要素法（Mean Element Method）
description: 通过对方程中的快变变量取平均来消除短周期摄动影响的方法，是轨道摄动分析的重要手段。
keywords: 平均要素法, Mean Element Method, 轨道力学, 姿态控制, 相对运动
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 通过对方程中的快变变量取平均来消除短周期摄动影响的方法，是轨道摄动分析的重要手段。
  image: /logo.png
permalink: /glossary/dynamics/mean-element-method/
---

# 平均要素法（Mean Element Method）
...
通过对方程中的快变变量取平均来消除短周期摄动影响的方法，是轨道摄动分析的重要手段。
