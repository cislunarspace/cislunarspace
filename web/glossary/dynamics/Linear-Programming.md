...
description: 目标函数和约束均为线性表达式的数学优化方法，是混合整数线性规划的基础。
keywords: 线性规划, Linear Programming, LP, 轨道力学, 动力学, 控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 目标函数和约束均为线性表达式的数学优化方法，是混合整数线性规划的基础。
  image: /logo.png
permalink: /glossary/dynamics/Linear-Programming/
---
...
目标函数和约束均为线性表达式的数学优化方法，是混合整数线性规划的基础。
