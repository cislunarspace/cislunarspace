---
title: 最小出离角（Minimum Flyout Angle）
description: 使转移时间最短的出离角下限，对应最直接轨迹。
keywords: 最小出离角, Minimum Flyout Angle, γ_min, 轨道力学, 姿态控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 使转移时间最短的出离角下限，对应最直接轨迹。
  image: /logo.png
permalink: /glossary/dynamics/minimum-flyout-angle/
---

# 最小出离角（Minimum Flyout Angle）
