---
title: 粗组合（Coarse Combination）
description: 轨迹拼接的第一步，筛选满足位置误差和速度增量约束的候选拼接点。
keywords: 粗组合, Coarse Combination, , 动力学, 非线性, 稳定性, 流形, 控制
author: 天疆说
date: 2026-07-31
...
wechatShare:
  ...
  image: /logo.png
og:
  title: 粗组合（Coarse Combination）详解 | 术语定义
  description: 轨迹拼接的第一步，筛选满足位置误差和速度增量约束的候选拼接点。
  image: /logo.png
  type: article
twitter:
  ...
  description: 轨迹拼接的第一步，筛选满足位置误差和速度增量约束的候选拼接点。
  image: /logo.png
permalink: /glossary/dynamics/coarse-combination/
---

# 粗组合（Coarse Combination）
...
轨迹拼接的第一步，筛选满足位置误差和速度增量约束的候选拼接点。
