---
title: 高斯-牛顿最小化（Gauss-Newton Minimisation）
description: 一种非线性最小二乘优化方法，用于改进姿态估计精度并生成协方差矩阵。
keywords: Gauss-Newton Minimisation, 三体问题, 动力学分叉, 轨道力学, 高斯-牛顿最小化
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 一种非线性最小二乘优化方法，用于改进姿态估计精度并生成协方差矩阵。
  image: /logo.png
permalink: /glossary/dynamics/gauss-newton-minimisation/
---

# 高斯-牛顿最小化（Gauss-Newton Minimisation）
...
一种非线性最小二乘优化方法，用于改进姿态估计精度并生成协方差矩阵。
