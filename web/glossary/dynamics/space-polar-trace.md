---
title: 空间极迹（Space Polar Trace）
description: 惯量椭球与不变平面交线在惯性空间的投影。
keywords: 空间极迹, Space Polar Trace, 轨道动力学, 三体问题, 平动点
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 惯量椭球与不变平面交线在惯性空间的投影。
  image: /logo.png
permalink: /glossary/dynamics/space-polar-trace/
---

# 空间极迹（Space Polar Trace）
...
空间极迹在地月空间动力学分析和任务轨道设计中具有应用价值。正确理解和应用空间极迹有助于优化轨道设计、控制策略和任务规划，是地月空间任务工程师需要掌握的基础知识。
