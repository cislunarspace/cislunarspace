---
title: 连接距离（Linkage Distance）
description: 衡量两个簇之间距离的指标，Ward连接取簇心距离并考虑簇大小。
keywords: 连接距离, Linkage Distance, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 衡量两个簇之间距离的指标，Ward连接取簇心距离并考虑簇大小。
  image: /logo.png
permalink: /glossary/dynamics/linkage-distance/
---

# 连接距离（Linkage Distance）
...
衡量两个簇之间距离的指标，Ward连接取簇心距离并考虑簇大小。
