---
title: 惯性固定指向（Inertially Fixed Pointing）
description: 发动机推力方向在惯性空间保持恒定的指向模式。
keywords: 惯性固定指向, Inertially Fixed Pointing, 轨道动力学, 三体问题, 平动点
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 发动机推力方向在惯性空间保持恒定的指向模式。
  image: /logo.png
permalink: /glossary/dynamics/inertially-fixed-pointing/
---

# 惯性固定指向（Inertially Fixed Pointing）

> 本文作者：[天疆说](https://blog.csdn.net/qq_33254264)
>
> 术语来源：章仁为 - 1998 - 卫星轨道姿态动力学与控制
>
> 本文地址：[https://cislunarspace.cn](https://cislunarspace.cn)

## 定义

发动机推力方向在惯性空间保持恒定的指向模式。

## 应用价值

惯性固定指向在地月空间动力学分析和任务轨道设计中具有应用价值。正确理解和应用惯性固定指向有助于优化轨道设计、控制策略和任务规划，是地月空间任务工程师需要掌握的基础知识。
