...
twitter:
  ...
  description: 航天器速度矢量与当地水平面之间的夹角。在转移轨道设计中，航迹角为零表示航天器速度方向恰好沿当地水平方向切向，对应近月点（或远月点）的特征。文中将航迹角作为微分修正的终止条件：积分至航迹角为零且导数为负时，判定到达近月点，从而提取该时刻的月心距用于约束修正。
  image: /logo.png
permalink: /glossary/dynamics/the-angle-between-the-spacecraft-velocity-vector-and-the-local-horizontal-plane-a-flight-path-angle-/
---
