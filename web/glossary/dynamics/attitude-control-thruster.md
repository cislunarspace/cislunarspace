---
title: 姿态控制推力器（Attitude Control Thruster）
description: 用于控制卫星姿态的小推力发动机。
keywords: 姿态控制推力器, Attitude Control Thruster, , 动力学, 非线性, 稳定性, 流形, 控制
author: 天疆说
date: 2026-07-31
...
wechatShare:
  ...
  image: /logo.png
og:
  title: 姿态控制推力器（Attitude Control Thruster）详解 | 术语定义
  description: 用于控制卫星姿态的小推力发动机。
  image: /logo.png
  type: article
twitter:
  ...
  description: 用于控制卫星姿态的小推力发动机。
  image: /logo.png
permalink: /glossary/dynamics/attitude-control-thruster/
---

# 姿态控制推力器（Attitude Control Thruster）
