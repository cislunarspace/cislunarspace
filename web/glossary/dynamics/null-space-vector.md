---
title: 零空间向量（Null Space Vector）
description: 雅可比矩阵零空间的向量。在伪弧长延拓中，零空间向量方向作为预测步的搜索方向，使得校正步能沿解曲线滑动而不偏离。
keywords: 零空间向量, Null Space Vector, 轨道动力学, 姿态控制, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 雅可比矩阵零空间的向量。在伪弧长延拓中，零空间向量方向作为预测步的搜索方向，使得校正步能沿解曲线滑动而不偏离。
  image: /logo.png
permalink: /glossary/dynamics/null-space-vector/
---
...
>
> 本文来源：张晨, 2024, 北京航空航天大学学报
>
> 站地址：[https://cislunarspace.cn](https://cislunarspace.cn)

## 定义

雅可比矩阵零空间的向量。在伪弧长延拓中，零空间向量方向作为预测步的搜索方向，使得校正步能沿解曲线滑动而不偏离。
