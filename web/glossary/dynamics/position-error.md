---
title: 位置误差（Position Error）
description: 拼接点处日地流形与地月流形位置向量的差，用于评价流形拼接精度和构造优化目标函数。
keywords: 位置误差, Position Error, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 拼接点处日地流形与地月流形位置向量的差，用于评价流形拼接精度和构造优化目标函数。
  image: /logo.png
permalink: /glossary/dynamics/position-error/
---
...
拼接点处日地流形与地月流形位置向量的差，用于评价流形拼接精度和构造优化目标函数。
