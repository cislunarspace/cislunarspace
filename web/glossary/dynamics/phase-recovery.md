---
title: 定相位恢复（Phase Recovery）
description: 在定相过程中自然恢复所需相位差的能力
keywords: 定相位恢复, Phase Recovery, 轨道优化, 控制理论, 非线性控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 在定相过程中自然恢复所需相位差的能力
  image: /logo.png
permalink: /glossary/dynamics/phase-recovery/
---

# 定相位恢复（Phase Recovery）
