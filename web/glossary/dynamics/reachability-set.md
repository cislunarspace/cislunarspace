---
title: 可达集（Reachability Set）
description: 在给定输入不确定范围下，卫星所有可能最终状态的集合。
keywords: 可达集, Reachability Set, 轨道动力学, 多体问题, 摄动
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 在给定输入不确定范围下，卫星所有可能最终状态的集合。
  image: /logo.png
permalink: /glossary/dynamics/reachability-set/
---
