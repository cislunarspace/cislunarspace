---
title: 瞬时密切平面（Osculating Plane）
description: 曲线上三个无限接近状态所确定的平面，曲率描述轨迹在该平面内偏离直线的程度。
keywords: 瞬时密切平面, Osculating Plane, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 曲线上三个无限接近状态所确定的平面，曲率描述轨迹在该平面内偏离直线的程度。
  image: /logo.png
permalink: /glossary/dynamics/osculating-plane/
---

# 瞬时密切平面（Osculating Plane）
...
曲线上三个无限接近状态所确定的平面，曲率描述轨迹在该平面内偏离直线的程度。
