---
title: 中心弗洛凯模态（Central Floquet Mode）
description: 弗洛凯理论中模为复共轭特征值对（模等于一）的模态，对应周期轨道附近的中心流形，产生准周期轨道。
keywords: 中心弗洛凯模态, Central Floquet Mode, , 动力学, 非线性, 稳定性, 流形, 控制
author: 天疆说
date: 2026-07-31
...
wechatShare:
  ...
  image: /logo.png
og:
  title: 中心弗洛凯模态（Central Floquet Mode）详解 | 术语定义
  description: 弗洛凯理论中模为复共轭特征值对（模等于一）的模态，对应周期轨道附近的中心流形，产生准周期轨道。
  image: /logo.png
  type: article
twitter:
  ...
  description: 弗洛凯理论中模为复共轭特征值对（模等于一）的模态，对应周期轨道附近的中心流形，产生准周期轨道。
  image: /logo.png
permalink: /glossary/dynamics/central-floquet-mode/
---

# 中心弗洛凯模态（Central Floquet Mode）
...
弗洛凯理论中模为复共轭特征值对（模等于一）的模态，对应周期轨道附近的中心流形，产生准周期轨道。
