---
title: 腿式机动（Legged Mobility）
description: 利用腿部结构实现移动的方式，可提供精确机动能力，但机械复杂且需要锚定系统。
keywords: 腿式机动, Legged Mobility, , 动力学, 非线性, 稳定性, 流形, 控制
author: 天疆说
date: 2026-07-31
...
wechatShare:
  ...
  image: /logo.png
og:
  title: 腿式机动（Legged Mobility）详解 | 术语定义
  description: 利用腿部结构实现移动的方式，可提供精确机动能力，但机械复杂且需要锚定系统。
  image: /logo.png
  type: article
twitter:
  ...
  description: 利用腿部结构实现移动的方式，可提供精确机动能力，但机械复杂且需要锚定系统。
  image: /logo.png
permalink: /glossary/dynamics/legged-mobility/
---

# 腿式机动（Legged Mobility）
...
利用腿部结构实现移动的方式，可提供精确机动能力，但机械复杂且需要锚定系统。
