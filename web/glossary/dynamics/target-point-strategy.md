---
title: 目标点策略（Target Point Strategy）
description: 一种平动点轨道保持策略。选取标称轨道上的若干节点作为目标点，通过控制使实际轨道与标称轨道在这些目标点处的偏差尽可能小。
keywords: 目标点策略, Target Point Strategy, 轨道优化, 控制理论, 非线性控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 一种平动点轨道保持策略。选取标称轨道上的若干节点作为目标点，通过控制使实际轨道与标称轨道在这些目标点处的偏差尽可能小。
  image: /logo.png
permalink: /glossary/dynamics/target-point-strategy/
---
...
一种平动点轨道保持策略。选取标称轨道上的若干节点作为目标点，通过控制使实际轨道与标称轨道在这些目标点处的偏差尽可能小。
