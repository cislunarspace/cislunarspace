---
title: 正则坐标（Canonical Coordinates）
description: 满足泊松括号关系的辛坐标，保持哈密顿方程的形式不变。
keywords: 正则坐标, Canonical Coordinates, 轨道设计, 最优控制, 动力学建模, 脉冲机动
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 满足泊松括号关系的辛坐标，保持哈密顿方程的形式不变。
  image: /logo.png
permalink: /glossary/dynamics/canonical-coordinates/
---

# 正则坐标（Canonical Coordinates）
