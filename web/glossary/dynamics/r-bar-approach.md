---
title: R-bar接近（R-bar Approach）
description: 沿R-bar方向（指向主天体方向）接近目标的对接策略。
keywords: R-bar接近, R-bar Approach, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 沿R-bar方向（指向主天体方向）接近目标的对接策略。
  image: /logo.png
permalink: /glossary/dynamics/r-bar-approach/
---

# R-bar接近（R-bar Approach）
