...
### 数学定义
CR3BP 共线平动点的线性化哈密顿量具有鞍×中心×中心结构，中心流形对应两个中心方向的全体，构成平动点轨道族（Halo、Lyapunov、Lissajous 轨道）栖息的低维不变流形。

### 关键性质
通过正则变换将双曲方向从中心流形中解耦后，双曲方向仅以乘积形式 $q_1 p_1$ 出现，中心流形上的运动仅由四个参数 $(I_2, \theta_2, I_3, \theta_3)$ 描述。

### 数值方法
在 Poincaré 截面中，Lyapunov 轨道对应 $I_3 = 0$ 的截面交线，Halo 轨道对应环面收缩至中心点处，Lissajous 轨道的 $\theta_3$ 遍历整个截面。

## 应用价值

中心流形理论是将高维相空间降维、揭示平动点轨道几何结构的核心工具，为地月空间共线平动点邻域的六维特征参数体系建立提供了理论基础，在轨道编目、辨识和任务设计中具有重要应用价值。
