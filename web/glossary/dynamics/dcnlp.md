...
keywords: 非线性规划直接配点法, Direct Collocation with Nonlinear Programming, DCNLP, 地月空间, cislunar
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 将连续最优控制问题离散化为有限维非线性规划问题的方法。通过在节点间采用Hermite-Simpson等插值多项式近似状态轨线，利用序列二次规划（SQP）等方法求解。
  image: /logo.png
permalink: /glossary/dynamics/dcnlp/
---
...
非线性规划直接配点法在轨道力学和任务规划中具有重要作用，可用于分析航天器的运动特性和优化转移轨道。
