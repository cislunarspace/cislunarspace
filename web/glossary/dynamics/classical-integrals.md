---
title: 经典积分（Classical Integrals）
description: 三体问题的十个经典积分，包括质心积分（6个参数）、角动量积分（3个参数）和能量积分（1个参数）。
keywords: 经典积分, Classical Integrals, 轨道优化, 控制理论, 非线性控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 三体问题的十个经典积分，包括质心积分（6个参数）、角动量积分（3个参数）和能量积分（1个参数）。
  image: /logo.png
permalink: /glossary/dynamics/classical-integrals/
---

# 经典积分（Classical Integrals）
...
三体问题的十个经典积分，包括质心积分（6个参数）、角动量积分（3个参数）和能量积分（1个参数）。
