---
title: 勒让德多项式（Legendre Polynomials）
description: 区间[-1,1]上均匀分布下相对于均匀概率密度函数的正交多项式。
keywords: 勒让德多项式, Legendre Polynomials, 轨道动力学, 三体问题, 平动点
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 区间[-1,1]上均匀分布下相对于均匀概率密度函数的正交多项式。
  image: /logo.png
permalink: /glossary/dynamics/legendre-polynomials/
---
...
区间[-1,1]上均匀分布下相对于均匀概率密度函数的正交多项式。
