---
title: 粘性轨道（Sticky Orbit）
description: 位于混沌海中但动力学寿命远超李雅普诺夫时间预测的轨道。粘性轨道暂时表现出类似稳定的行为，局限于KAM环面附近的小区域内运动，之后才扩散到更广泛的混沌区域。在远距离逆行区域，粘性轨道可通过BUPO的流形暂时捕获航天器。
keywords: 粘性轨道, Sticky Orbit, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 位于混沌海中但动力学寿命远超李雅普诺夫时间预测的轨道。粘性轨道暂时表现出类似稳定的行为，局限于KAM环面附近的小区域内运动，之后才扩散到更广泛的混沌区域。在远距离逆行区域，粘性轨道可通过BUPO的流形暂时捕获航天器。
  image: /logo.png
permalink: /glossary/dynamics/sticky-orbit/
---
...
位于混沌海中但动力学寿命远超李雅普诺夫时间预测的轨道。粘性轨道暂时表现出类似稳定的行为，局限于KAM环面附近的小区域内运动，之后才扩散到更广泛的混沌区域。在远距离逆行区域，粘性轨道可通过BUPO的流形暂时捕获航天器。
