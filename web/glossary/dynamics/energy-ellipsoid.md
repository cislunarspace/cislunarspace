---
title: 能量椭球（Energy Ellipsoid）
description: 在角速度空间描述常能量条件的椭球面。
keywords: 能量椭球, Energy Ellipsoid, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 在角速度空间描述常能量条件的椭球面。
  image: /logo.png
permalink: /glossary/dynamics/energy-ellipsoid/
---

# 能量椭球（Energy Ellipsoid）
