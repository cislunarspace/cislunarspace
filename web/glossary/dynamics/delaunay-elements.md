---
title: 德洛内元（Delaunay Elements）
description: 使三体问题运动方程呈现哈密顿形式的一组共轭参数，包括L、G、H及其共轭角变量。
keywords: 德洛内元, Delaunay Elements, 轨道动力学, 控制理论, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 使三体问题运动方程呈现哈密顿形式的一组共轭参数，包括L、G、H及其共轭角变量。
  image: /logo.png
permalink: /glossary/dynamics/delaunay-elements/
---

# 德洛内元（Delaunay Elements）
...
使三体问题运动方程呈现哈密顿形式的一组共轭参数，包括L、G、H及其共轭角变量。
