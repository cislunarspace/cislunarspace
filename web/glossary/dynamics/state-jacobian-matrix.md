---
title: 状态Jacobian矩阵（State Jacobian Matrix）
description: 非线性状态转移函数对状态向量的偏导数矩阵，用于计算状态转移矩阵，在扩展卡尔曼滤波中线性化轨道动力学。
keywords: 状态Jacobian矩阵, State Jacobian Matrix, , 动力学, 非线性, 稳定性, 流形, 控制
author: 天疆说
date: 2026-07-31
...
wechatShare:
  ...
  image: /logo.png
og:
  title: 状态Jacobian矩阵（State Jacobian Matrix）详解 | 术语定义
  description: 非线性状态转移函数对状态向量的偏导数矩阵，用于计算状态转移矩阵，在扩展卡尔曼滤波中线性化轨道动力学。
  image: /logo.png
  type: article
twitter:
  ...
  description: 非线性状态转移函数对状态向量的偏导数矩阵，用于计算状态转移矩阵，在扩展卡尔曼滤波中线性化轨道动力学。
  image: /logo.png
permalink: /glossary/dynamics/state-jacobian-matrix/
---

# 状态Jacobian矩阵（State Jacobian Matrix）
...
非线性状态转移函数对状态向量的偏导数矩阵，用于计算状态转移矩阵，在扩展卡尔曼滤波中线性化轨道动力学。
