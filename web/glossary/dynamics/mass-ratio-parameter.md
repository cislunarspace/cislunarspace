---
title: 质量比参数（Mass Ratio Parameter）
...
twitter:
  ...
  description: CRTBP中定义的系统唯一参数，等于副天体质量与两天体质量之和的比值。
  image: /logo.png
permalink: /glossary/dynamics/mass-ratio-parameter/
---

# 质量比参数（Mass Ratio Parameter）
...
CRTBP中定义的系统唯一参数，等于副天体质量与两天体质量之和的比值。

## 应用价值

在质量比参数的分析中，可用于轨道传播和机动设计，帮助工程师评估航天器在不同动力学环境下的运动特性。
该概念为地月空间任务设计提供了理论基础，尤其在平动点轨道设计和低能转移分析中具有重要应用价值。
利用质量比参数进行轨迹优化，可以有效降低任务燃料消耗，提高任务经济效益。
在任务设计中，质量比参数的分析有助于理解航天器在复杂引力场中的行为，指导轨道保持策略的制定。
