---
title: 拱线变轨（Apsidal Transfer）
description: 通过转动椭圆拱线实现共面椭圆轨道间转移的双脉冲最优控制。
keywords: 拱线变轨, Apsidal Transfer, 轨道动力学, 控制理论, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 通过转动椭圆拱线实现共面椭圆轨道间转移的双脉冲最优控制。
  image: /logo.png
permalink: /glossary/dynamics/apsidal-transfer/
---
...
通过转动椭圆拱线实现共面椭圆轨道间转移的双脉冲最优控制。

## 应用价值

拱线变轨在轨道设计和轨迹优化中用于将连续控制问题离散化，通过非线性规划求解最优控制序列。
