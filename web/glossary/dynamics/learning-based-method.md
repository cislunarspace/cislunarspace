---
title: 基于学习的方法（Learning-Based Method）
description: 利用神经网络等机器学习模型，通过学习最优控制问题输入与最优解之间的映射关系来生成制导律的方法。相比直接法和间接法，学习方法可在部署时实现实时或近实时求解，但训练数据的质量和泛化能力是关键挑战。
keywords: 基于学习的方法, Learning-Based Method, 轨道优化, 控制理论, 非线性控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 利用神经网络等机器学习模型，通过学习最优控制问题输入与最优解之间的映射关系来生成制导律的方法。相比直接法和间接法，学习方法可在部署时实现实时或近实时求解，但训练数据的质量和泛化能力是关键挑战。
  image: /logo.png
permalink: /glossary/dynamics/learning-based-method/
---
...
利用神经网络等机器学习模型，通过学习最优控制问题输入与最优解之间的映射关系来生成制导律的方法。相比直接法和间接法，学习方法可在部署时实现实时或近实时求解，但训练数据的质量和泛化能力是关键挑战。
