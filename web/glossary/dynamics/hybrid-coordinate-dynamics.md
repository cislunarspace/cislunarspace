---
title: 混合坐标动力学（Hybrid Coordinate Dynamics）
description: 同时用惯性和弹性坐标描述带挠性附件卫星姿态运动的建模方法。
keywords: 混合坐标动力学, Hybrid Coordinate Dynamics, 轨道优化, 控制理论, 非线性控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 同时用惯性和弹性坐标描述带挠性附件卫星姿态运动的建模方法。
  image: /logo.png
permalink: /glossary/dynamics/hybrid-coordinate-dynamics/
---

# 混合坐标动力学（Hybrid Coordinate Dynamics）
