---
title: 弱不稳定（Weakly Unstable）
description: 李雅普诺夫指数较小的不稳定状态，典型特征值约为3.8每年，可用较小推进剂维持。
keywords: 弱不稳定, Weakly Unstable, 轨道优化, 控制理论, 非线性控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 李雅普诺夫指数较小的不稳定状态，典型特征值约为3.8每年，可用较小推进剂维持。
  image: /logo.png
permalink: /glossary/dynamics/weakly-unstable/
---

# 弱不稳定（Weakly Unstable）
...
李雅普诺夫指数较小的不稳定状态，典型特征值约为3.8每年，可用较小推进剂维持。
