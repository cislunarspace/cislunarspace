---
title: 从属航天器（Deputy Spacecraft）
description: 在编队飞行或交会对接任务中，受控接近主航天器的航天器。也称追踪航天器。
keywords: 从属航天器, Deputy Spacecraft, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 在编队飞行或交会对接任务中，受控接近主航天器的航天器。也称追踪航天器。
  image: /logo.png
permalink: /glossary/dynamics/deputy-spacecraft/
---

# 从属航天器（Deputy Spacecraft）
...
在编队飞行或交会对接任务中，受控接近主航天器的航天器。也称追踪航天器。
