---
title: 状态权重矩阵（State Weighting Matrix）
description: LQR中用于权衡状态误差的半正定对称矩阵，决定了各状态变量的相对重要性。
keywords: 状态权重矩阵, State Weighting Matrix, Q, 轨道力学, 动力学, 控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: LQR中用于权衡状态误差的半正定对称矩阵，决定了各状态变量的相对重要性。
  image: /logo.png
permalink: /glossary/dynamics/State-Weighting-Matrix/
---

# 状态权重矩阵（State Weighting Matrix）
...
LQR中用于权衡状态误差的半正定对称矩阵，决定了各状态变量的相对重要性。
