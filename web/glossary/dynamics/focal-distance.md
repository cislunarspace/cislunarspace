---
title: 焦点距（Focal Distance）
description: 描述共线平动点附近轨道几何的参数。
keywords: 焦点距, Focal Distance, 轨道动力学, 控制理论, 数值仿真
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 描述共线平动点附近轨道几何的参数。
  image: /logo.png
permalink: /glossary/dynamics/focal-distance/
---
...
焦点距涉及地月空间航天器的运动特性分析和控制问题。在实际任务设计中，利用该方法可以分析轨道稳定性、计算控制策略，或评估摄动因素对轨道的影响，为任务安全性和可靠性提供保障。
