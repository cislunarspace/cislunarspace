---
title: Q-bar张量（Q-bar Tensor, QBT）
description: 累积过程噪声协方差状态灵敏度张量，是QBM对初始状态的偏导数。
keywords: Q-bar张量, Q-bar Tensor, QBT, 轨道动力学, 控制理论, 数值仿真
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 累积过程噪声协方差状态灵敏度张量，是QBM对初始状态的偏导数。
  image: /logo.png
permalink: /glossary/dynamics/q-bar-tensor-qbt/
---

# Q-bar张量（Q-bar Tensor, QBT）
...
累积过程噪声协方差状态灵敏度张量，是QBM对初始状态的偏导数。

## 应用价值

Q-bar张量涉及地月空间航天器的运动特性分析和控制问题。在实际任务设计中，利用该方法可以分析轨道稳定性、计算控制策略，或评估摄动因素对轨道的影响，为任务安全性和可靠性提供保障。
