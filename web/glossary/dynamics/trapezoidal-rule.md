...
description: 配点法中使用的一种简单隐式积分规则，在每段的两个端点之间用梯形近似积分。精度较低但计算效率高。
keywords: 梯形法则, Trapezoidal Rule, 轨道优化, 控制理论, 非线性控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 配点法中使用的一种简单隐式积分规则，在每段的两个端点之间用梯形近似积分。精度较低但计算效率高。
  image: /logo.png
permalink: /glossary/dynamics/trapezoidal-rule/
---
...
配点法中使用的一种简单隐式积分规则，在每段的两个端点之间用梯形近似积分。精度较低但计算效率高。
