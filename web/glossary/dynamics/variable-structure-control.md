---
title: 变结构控制（Variable Structure Control）
description: 一种非线性控制方法，通过在控制过程中在不同控制结构间切换，使系统状态沿滑模面滑动，实现对不确定性和扰动的鲁棒性。
keywords: 变结构控制, Variable Structure Control, VSC, 轨道优化, 控制理论
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 一种非线性控制方法，通过在控制过程中在不同控制结构间切换，使系统状态沿滑模面滑动，实现对不确定性和扰动的鲁棒性。
  image: /logo.png
permalink: /glossary/dynamics/variable-structure-control/
---
...
一种非线性控制方法，通过在控制过程中在不同控制结构间切换，使系统状态沿滑模面滑动，实现对不确定性和扰动的鲁棒性。
