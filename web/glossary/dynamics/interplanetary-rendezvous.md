---
title: 行星际交会（Interplanetary Rendezvous）
description: 两个航天器在行星际空间的会合。
keywords: 行星际交会, Interplanetary Rendezvous, 轨道动力学, 姿态控制, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 两个航天器在行星际空间的会合。
  image: /logo.png
permalink: /glossary/dynamics/interplanetary-rendezvous/
---

# 行星际交会（Interplanetary Rendezvous）
