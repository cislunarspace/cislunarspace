---
title: 收敛容差（Convergence Tolerance）
description: 迭代算法中判定解是否满足要求的误差阈值。文中统一设定为10^{-9}，影响精度和计算时间的平衡。
keywords: 收敛容差, Convergence Tolerance
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 迭代算法中判定解是否满足要求的误差阈值。文中统一设定为10^{-9}，影响精度和计算时间的平衡。
  image: /logo.png
permalink: /glossary/dynamics/convergence-tolerance/
---
...
迭代算法中判定解是否满足要求的误差阈值。文中统一设定为10^{-9}，影响精度和计算时间的平衡。
