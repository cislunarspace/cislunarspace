---
title: 切向脉冲机动（Tangential Impulsive Maneuver）
description: 沿轨道速度方向施加的瞬时速度变化。论文在转移轨道设计中施加两个切向约束：在初始时刻与LEO相切，在终止时刻与DRO相切，使脉冲机动方向与轨道切向一致，从而最大化速度增量对轨道形状的改变效率。
keywords: 切向脉冲机动, Tangential Impulsive Maneuver, 轨道动力学, 姿态控制, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 沿轨道速度方向施加的瞬时速度变化。论文在转移轨道设计中施加两个切向约束：在初始时刻与LEO相切，在终止时刻与DRO相切，使脉冲机动方向与轨道切向一致，从而最大化速度增量对轨道形状的改变效率。
  image: /logo.png
permalink: /glossary/dynamics/tangential-impulsive-maneuver/
---
...
>
> 本文来源：Transfer to Distant Retrograde Orbits Using Manifold Theory
>
> 站地址：[https://cislunarspace.cn](https://cislunarspace.cn)

## 定义

沿轨道速度方向施加的瞬时速度变化。论文在转移轨道设计中施加两个切向约束：在初始时刻与LEO相切，在终止时刻与DRO相切，使脉冲机动方向与轨道切向一致，从而最大化速度增量对轨道形状的改变效率。
