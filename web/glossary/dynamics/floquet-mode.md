---
title: 弗洛凯模态（Floquet Mode）
description: 周期系统按弗洛凯理论展开的本征模态，描述线性周期微分方程解的空间结构。
keywords: 弗洛凯模态, Floquet Mode, 轨道动力学, 姿态控制, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 周期系统按弗洛凯理论展开的本征模态，描述线性周期微分方程解的空间结构。
  image: /logo.png
permalink: /glossary/dynamics/floquet-mode/
---
...
>
> 本文来源：Gómez et al. 2001, Ch.3
>
> 站地址：[https://cislunarspace.cn](https://cislunarspace.cn)

## 定义

周期系统按弗洛凯理论展开的本征模态，描述线性周期微分方程解的空间结构。
