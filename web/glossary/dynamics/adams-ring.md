---
title: 亚当斯环（Adams Ring）
description: 海王星最外层的稀疏环带，其弧状结构被认为由卫星Galatea的共振效应维持。
keywords: 亚当斯环, Adams Ring, 轨道动力学, 三体问题, 平动点
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 海王星最外层的稀疏环带，其弧状结构被认为由卫星Galatea的共振效应维持。
  image: /logo.png
permalink: /glossary/dynamics/adams-ring/
---
...
>
> 术语来源：Murray & Dermott 1999, Sect. 1.6.5, 10.8
>
> 本文地址：[https://cislunarspace.cn](https://cislunarspace.cn)

## 定义

海王星最外层的稀疏环带，其弧状结构被认为由卫星Galatea的共振效应维持。

## 应用价值

亚当斯环在地月空间动力学分析和任务轨道设计中具有应用价值。正确理解和应用亚当斯环有助于优化轨道设计、控制策略和任务规划，是地月空间任务工程师需要掌握的基础知识。
...
- Murray & Dermott 1999, Sect. 1.6.5, 10.8
