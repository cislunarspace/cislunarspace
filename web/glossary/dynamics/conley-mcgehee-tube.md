---
title: Conley-McGehee管（Conley-McGehee Tube）
description: 限制性三体问题中，Lyapunov轨道稳定流形和不稳定流形在构型空间中扩展形成的二维管状结构。Conley和McGehee证明该管作为转移轨道与非转移轨道的分界面，管内聚集所有穿行转移轨道。是分析平动点附近转移条件的重要工具。
keywords: Conley-McGehee管, Conley-McGehee Tube, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 限制性三体问题中，Lyapunov轨道稳定流形和不稳定流形在构型空间中扩展形成的二维管状结构。Conley和McGehee证明该管作为转移轨道与非转移轨道的分界面，管内聚集所有穿行转移轨道。是分析平动点附近转移条件的重要工具。
  image: /logo.png
permalink: /glossary/dynamics/conley-mcgehee-tube/
---

# Conley-McGehee管（Conley-McGehee Tube）
...
限制性三体问题中，Lyapunov轨道稳定流形和不稳定流形在构型空间中扩展形成的二维管状结构。Conley和McGehee证明该管作为转移轨道与非转移轨道的分界面，管内聚集所有穿行转移轨道。是分析平动点附近转移条件的重要工具。
