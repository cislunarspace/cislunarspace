---
title: 一次冲量转移（Single-Impulse Transfer）
description: 仅在转移起点进行一次冲量机动的轨道转移策略，与多次冲量或低推力持续推进相对，典型用于外部稳定流形转移方案。
keywords: 一次冲量转移, Single-Impulse Transfer, 轨道优化, 控制理论, 非线性控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 仅在转移起点进行一次冲量机动的轨道转移策略，与多次冲量或低推力持续推进相对，典型用于外部稳定流形转移方案。
  image: /logo.png
permalink: /glossary/dynamics/single-impulse-transfer/
---

# 一次冲量转移（Single-Impulse Transfer）
...
仅在转移起点进行一次冲量机动的轨道转移策略，与多次冲量或低推力持续推进相对，典型用于外部稳定流形转移方案。
