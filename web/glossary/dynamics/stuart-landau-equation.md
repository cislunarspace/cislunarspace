---
title: 斯图尔特-特鲁克特变换（Stuart-Landau Equation）
description: 描述接近Hopf分岔点处系统行为的非线性常微分方程，用于分析稳定性转换。
keywords: 斯图尔特-特鲁克特变换, Stuart-Landau Equation, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 描述接近Hopf分岔点处系统行为的非线性常微分方程，用于分析稳定性转换。
  image: /logo.png
permalink: /glossary/dynamics/stuart-landau-equation/
---

# 斯图尔特-特鲁克特变换（Stuart-Landau Equation）
...
描述接近Hopf分岔点处系统行为的非线性常微分方程，用于分析稳定性转换。
