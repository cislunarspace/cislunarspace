---
title: 双基聚类法（Two-Dominant Clustering）
description: 同时使用k-means和聚合聚类生成基聚类结果的集成方法。
keywords: 双基聚类法, Two-Dominant Clustering
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 同时使用k-means和聚合聚类生成基聚类结果的集成方法。
  image: /logo.png
permalink: /glossary/dynamics/two-dominant-clustering/
---

# 双基聚类法（Two-Dominant Clustering）
