---
title: 能量成形控制（Energy-shaping Control）
description: 通过调控系统能量函数使轨道收敛到参考状态的控制方法。
keywords: 能量成形控制, Energy-shaping Control, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 通过调控系统能量函数使轨道收敛到参考状态的控制方法。
  image: /logo.png
permalink: /glossary/dynamics/energy-shaping-control/
---

# 能量成形控制（Energy-shaping Control）
