---
title: 正不变约束容许集（Positively Invariant Constraint Admissible Set）
description: 航天器在约束条件下保持的最大不变集合，用于约束满足型机动规划
keywords: 正不变约束容许集, Positively Invariant Constraint Admissible Set, PICAS, 轨道动力学, 姿态控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 航天器在约束条件下保持的最大不变集合，用于约束满足型机动规划
  image: /logo.png
permalink: /glossary/dynamics/positively-invariant-constraint-admissible-set/
---

# 正不变约束容许集（Positively Invariant Constraint Admissible Set）
...
航天器在约束条件下保持的最大不变集合，用于约束满足型机动规划
