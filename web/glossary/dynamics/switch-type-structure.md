---
title: 开关型结构（Switch-type Structure）
description: CMDP最优调度策略呈现的切换特征，当某卫星状态固定时，另一卫星的调度决策随其AoI状态呈现开关式切换。
keywords: 开关型结构, Switch-type Structure, , 动力学, 非线性, 稳定性, 流形, 控制
author: 天疆说
date: 2026-07-31
...
wechatShare:
  ...
  image: /logo.png
og:
  title: 开关型结构（Switch-type Structure）详解 | 术语定义
  description: CMDP最优调度策略呈现的切换特征，当某卫星状态固定时，另一卫星的调度决策随其AoI状态呈现开关式切换。
  image: /logo.png
  type: article
twitter:
  ...
  description: CMDP最优调度策略呈现的切换特征，当某卫星状态固定时，另一卫星的调度决策随其AoI状态呈现开关式切换。
  image: /logo.png
permalink: /glossary/dynamics/switch-type-structure/
---

# 开关型结构（Switch-type Structure）
...
CMDP最优调度策略呈现的切换特征，当某卫星状态固定时，另一卫星的调度决策随其AoI状态呈现开关式切换。
