...
description: 一种鲁棒参数估计方法，通过随机抽取最小数据集拟合模型，迭代剔除离群值。
keywords: RANSAC, Random Sample Consensus, RANSAC, 轨道动力学, 姿态控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 一种鲁棒参数估计方法，通过随机抽取最小数据集拟合模型，迭代剔除离群值。
  image: /logo.png
permalink: /glossary/dynamics/random-sample-consensus/
---
...
一种鲁棒参数估计方法，通过随机抽取最小数据集拟合模型，迭代剔除离群值。
