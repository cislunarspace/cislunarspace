...
description: 一种先进的一阶策略优化算法，通过引入截断代理目标函数来保证策略更新的稳定性与收敛性。
keywords: 近端策略优化, Proximal Policy Optimization, 轨道动力学, 多体问题, 摄动
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 一种先进的一阶策略优化算法，通过引入截断代理目标函数来保证策略更新的稳定性与收敛性。
  image: /logo.png
permalink: /glossary/dynamics/proximal-policy-optimization/
---
...
一种先进的一阶策略优化算法，通过引入截断代理目标函数来保证策略更新的稳定性与收敛性。
