...
description: 通过相空间特定低维子流形的截面来可视化高维动力学行为的方法。
keywords: 庞加莱截面, Poincaré Section, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 通过相空间特定低维子流形的截面来可视化高维动力学行为的方法。
  image: /logo.png
permalink: /glossary/dynamics/poincar-section/
---
