---
title: 探测器定位（Probe Targeting）
description: 在转移轨道设计中确定接目标点位置和速度的技术。
keywords: 探测器定位, Probe Targeting, 轨道动力学, 控制理论, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 在转移轨道设计中确定接目标点位置和速度的技术。
  image: /logo.png
permalink: /glossary/dynamics/probe-targeting/
---
