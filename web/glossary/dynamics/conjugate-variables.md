---
title: 共轭变量（Conjugate Variables）
description: 哈密顿系统中满足泊松括号{q_i, p_j} = delta_ij的一对位置和动量变量。
keywords: Conjugate Variables, 三体问题, 共轭变量, 动力学分叉, 轨道力学
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 哈密顿系统中满足泊松括号{q_i, p_j} = delta_ij的一对位置和动量变量。
  image: /logo.png
permalink: /glossary/dynamics/conjugate-variables/
---

# 共轭变量（Conjugate Variables）
...
哈密顿系统中满足泊松括号{q_i, p_j} = delta_ij的一对位置和动量变量。
