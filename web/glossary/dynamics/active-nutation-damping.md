---
title: 主动章动阻尼（Active Nutation Damping）
description: 通过反馈控制主动施加阻尼力矩抑制章动的主动控制方法。
keywords: 主动章动阻尼, Active Nutation Damping, 轨道动力学, 姿态控制, 最优控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 通过反馈控制主动施加阻尼力矩抑制章动的主动控制方法。
  image: /logo.png
permalink: /glossary/dynamics/active-nutation-damping/
---

# 主动章动阻尼（Active Nutation Damping）

> 本文作者：[天疆说](https://blog.csdn.net/qq_33254264)
>
> 本文来源：章仁为 - 1998 - 卫星轨道姿态动力学与控制
>
> 站地址：[https://cislunarspace.cn](https://cislunarspace.cn)

## 定义

通过反馈控制主动施加阻尼力矩抑制章动的主动控制方法。
