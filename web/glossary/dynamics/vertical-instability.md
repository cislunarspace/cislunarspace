---
title: 垂直不稳定性（Vertical Instability）
description: 平面周期轨道在垂直方向（面外）上的失稳特性。当初始微小扰动沿垂直方向施加在周期轨道上时，扰动随时间呈指数增长。垂直不稳定性与水平不稳定性共同决定周期轨道的整体稳定性。
keywords: 垂直不稳定性, Vertical Instability, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 平面周期轨道在垂直方向（面外）上的失稳特性。当初始微小扰动沿垂直方向施加在周期轨道上时，扰动随时间呈指数增长。垂直不稳定性与水平不稳定性共同决定周期轨道的整体稳定性。
  image: /logo.png
permalink: /glossary/dynamics/vertical-instability/
---

# 垂直不稳定性（Vertical Instability）
...
平面周期轨道在垂直方向（面外）上的失稳特性。当初始微小扰动沿垂直方向施加在周期轨道上时，扰动随时间呈指数增长。垂直不稳定性与水平不稳定性共同决定周期轨道的整体稳定性。
