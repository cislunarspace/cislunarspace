---
title: 矩映射（Moment Mapping）
description: 将输入统计矩映射到输出统计矩的过程，通过Taylor级数展开实现。
keywords: 矩映射, Moment Mapping, 轨道动力学, 轨道优化, 非线性动力学
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 将输入统计矩映射到输出统计矩的过程，通过Taylor级数展开实现。
  image: /logo.png
permalink: /glossary/dynamics/moment-mapping/
---
...
将输入统计矩映射到输出统计矩的过程，通过Taylor级数展开实现。
