---
title: 过程协方差矩阵（Process Covariance Matrix）
description: 表示系统模型不确定性（未建模动力学、扰动等）的协方差矩阵。在卡尔曼滤波中与状态预测协方差一起传播。
keywords: 过程协方差矩阵, Process Covariance Matrix, 轨道力学, 姿态控制, 相对运动
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 表示系统模型不确定性（未建模动力学、扰动等）的协方差矩阵。在卡尔曼滤波中与状态预测协方差一起传播。
  image: /logo.png
permalink: /glossary/dynamics/process-covariance-matrix/
---
...
表示系统模型不确定性（未建模动力学、扰动等）的协方差矩阵。在卡尔曼滤波中与状态预测协方差一起传播。
