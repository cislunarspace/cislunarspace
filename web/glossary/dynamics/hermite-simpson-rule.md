---
title: 厄米特-辛普森规则（Hermite-Simpson Rule）
description: 配点法中使用的隐式积分规则，使用Hermite立方多项式在配置点间插值状态，并在段中点处施加缺陷约束。
keywords: Hermite-Simpson Rule, 三体问题, 动力学分叉, 厄米特-辛普森规则, 轨道力学
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 配点法中使用的隐式积分规则，使用Hermite立方多项式在配置点间插值状态，并在段中点处施加缺陷约束。
  image: /logo.png
permalink: /glossary/dynamics/hermite-simpson-rule/
---

# 厄米特-辛普森规则（Hermite-Simpson Rule）
...
配点法中使用的隐式积分规则，使用Hermite立方多项式在配置点间插值状态，并在段中点处施加缺陷约束。
