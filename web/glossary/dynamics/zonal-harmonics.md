---
title: 带形谐函数（Zonal Harmonics）
description: 描述引力势随纬度变化的谐函数项，沿纬度有正负交替
keywords: 带形谐函数, Zonal Harmonics, 轨道动力学, 多体问题, 摄动
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 描述引力势随纬度变化的谐函数项，沿纬度有正负交替
  image: /logo.png
permalink: /glossary/dynamics/zonal-harmonics/
---

# 带形谐函数（Zonal Harmonics）
