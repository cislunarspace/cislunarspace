---
title: 循环近端策略优化（Recurrent PPO）
description: 适用于LSTM网络的PPO变体，通过时间反向传播计算梯度，适合处理非平稳时间序列。
keywords: 循环近端策略优化, Recurrent PPO, 轨道设计, 最优控制, 动力学建模, 脉冲机动
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 适用于LSTM网络的PPO变体，通过时间反向传播计算梯度，适合处理非平稳时间序列。
  image: /logo.png
permalink: /glossary/dynamics/recurrent-ppo/
---

# 循环近端策略优化（Recurrent PPO）
...
适用于LSTM网络的PPO变体，通过时间反向传播计算梯度，适合处理非平稳时间序列。
