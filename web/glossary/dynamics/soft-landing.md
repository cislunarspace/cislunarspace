---
title: 软着陆（Soft Landing）
description: 飞行器以接近零的速度在目标位置安全着陆的过程，是动力下降的最终目标。
keywords: 软着陆, Soft Landing, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 飞行器以接近零的速度在目标位置安全着陆的过程，是动力下降的最终目标。
  image: /logo.png
permalink: /glossary/dynamics/soft-landing/
---
...
飞行器以接近零的速度在目标位置安全着陆的过程，是动力下降的最终目标。
