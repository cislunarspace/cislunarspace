---
title: 碰撞规避（Collision Avoidance）
description: 在交会对接和近距离操作中防止航天器与目标发生碰撞的约束，是任务安全的关键要求。
keywords: 碰撞规避, Collision Avoidance, 轨道动力学, 姿态控制, 稳定性
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 在交会对接和近距离操作中防止航天器与目标发生碰撞的约束，是任务安全的关键要求。
  image: /logo.png
permalink: /glossary/dynamics/collision-avoidance/
---
...
在交会对接和近距离操作中防止航天器与目标发生碰撞的约束，是任务安全的关键要求。
