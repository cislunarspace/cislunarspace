---
title: 指向误差锥（Thrust Pointing Error Cone）
description: 实际推力方向相对于标称推力方向的偏差范围，形成一个以标称方向为轴线的圆锥形区域。
keywords: 指向误差锥, Thrust Pointing Error Cone, 轨道优化, 控制理论, 非线性控制
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 实际推力方向相对于标称推力方向的偏差范围，形成一个以标称方向为轴线的圆锥形区域。
  image: /logo.png
permalink: /glossary/dynamics/thrust-pointing-error-cone/
---

# 指向误差锥（Thrust Pointing Error Cone）
...
实际推力方向相对于标称推力方向的偏差范围，形成一个以标称方向为轴线的圆锥形区域。
