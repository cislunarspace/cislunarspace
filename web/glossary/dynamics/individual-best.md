---
title: 个体极值（Individual Best）
description: 粒子群中每个粒子自身经历过的最优位置，用于引导粒子向自身历史最佳方向搜索。
keywords: 个体极值, Individual Best, 动力学, 摄动, 轨道
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 粒子群中每个粒子自身经历过的最优位置，用于引导粒子向自身历史最佳方向搜索。
  image: /logo.png
permalink: /glossary/dynamics/individual-best/
---

# 个体极值（Individual Best）
...
粒子群中每个粒子自身经历过的最优位置，用于引导粒子向自身历史最佳方向搜索。
