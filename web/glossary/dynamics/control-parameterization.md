---
title: 控制参数化（Control Parameterization）
description: 将连续控制函数离散化为有限参数的方法。配点法中在节点上参数化控制，段内用多项式插值。
...
twitter:
  ...
  description: 将连续控制函数离散化为有限参数的方法。配点法中在节点上参数化控制，段内用多项式插值。
  image: /logo.png
permalink: /glossary/dynamics/control-parameterization/
---

# 控制参数化（Control Parameterization）
...
将连续控制函数离散化为有限参数的方法。配点法中在节点上参数化控制，段内用多项式插值。
