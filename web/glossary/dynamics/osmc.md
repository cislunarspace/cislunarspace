...
description: 将最优控制与滑模控制相结合的复合控制方法。在滑模面设计中嵌入线性二次型最优控制的反馈增益，使系统在滑模面上的运动对预定义的二次型性能指标最优；同时通过不连续切换项补偿不确定性和外部扰动。相比纯最优控制，鲁棒性更强；相比纯滑模控制，燃料消耗更低。该方法在地月空间轨道保持中表现出优势：弱扰动下与线性二次型调节器性能相当，强
keywords: 最优滑模控制, Optimal Sliding Mode Control, OSMC, OSMC, dynamics
author: 天疆说
date: 2026-07-31
...
最优滑模控制方法在地月空间轨道保持和转移控制中具有重要应用，能够实现航天器的精确导航与轨道控制，支持月球轨道器的长期运行任务。
