---
title: 合作目标（Cooperative Target）
description: 表面安装有合作标识器（如ArUco标记）的目标航天器，可被追踪航天器进行姿态估计
keywords: 合作目标, Cooperative Target, 观测, 雷达, SAR
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 表面安装有合作标识器（如ArUco标记）的目标航天器，可被追踪航天器进行姿态估计
  image: /logo.png
permalink: /glossary/observation/cooperative-target/
---
...
表面安装有合作标识器（如ArUco标记）的目标航天器，可被追踪航天器进行姿态估计
