---
title: 指向方向（Pointing Direction）
description: 观测器传感器所指的空间方向，离散化为有限个方位角和仰角组合，用于优化传感器任务规划。
keywords: 指向方向, Pointing Direction, 观测, 雷达, SAR
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 观测器传感器所指的空间方向，离散化为有限个方位角和仰角组合，用于优化传感器任务规划。
  image: /logo.png
permalink: /glossary/observation/pointing-direction/
---

# 指向方向（Pointing Direction）
...
观测器传感器所指的空间方向，离散化为有限个方位角和仰角组合，用于优化传感器任务规划。
