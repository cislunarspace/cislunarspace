---
title: 姿态几何确定（Geometric Attitude Determination）
description: 利用两个独立矢量观测直接计算姿态的方法，如双矢量定姿算法。
keywords: 姿态几何确定, Geometric Attitude Determination
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 利用两个独立矢量观测直接计算姿态的方法，如双矢量定姿算法。
  image: /logo.png
permalink: /glossary/observation/geometric-attitude-determination/
---

# 姿态几何确定（Geometric Attitude Determination）
