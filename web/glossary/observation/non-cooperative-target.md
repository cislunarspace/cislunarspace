---
title: 非合作目标（Non-Cooperative Target）
description: 不主动发射合作信号（如应答信号、测距信标）的空间目标。对其定轨只能依赖被动观测手段（如光学测角），无法获得高精度的距离和速度测量。
keywords: 非合作目标, Non-Cooperative Target, 观测, 雷达, SAR
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: 不主动发射合作信号（如应答信号、测距信标）的空间目标。对其定轨只能依赖被动观测手段（如光学测角），无法获得高精度的距离和速度测量。
  image: /logo.png
permalink: /glossary/observation/non-cooperative-target/
---
...
不主动发射合作信号（如应答信号、测距信标）的空间目标。对其定轨只能依赖被动观测手段（如光学测角），无法获得高精度的距离和速度测量。
