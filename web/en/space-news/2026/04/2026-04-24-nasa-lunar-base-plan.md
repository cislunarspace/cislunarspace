...
title: "NASA Suspends Lunar Gateway Space Station Plan, Shifts to Building Lunar Surface Base"
...
[View lunar South Pole images (NASA official site)](https://www.nasa.gov/humans-in-space/artemis-science/)
...
1. **Cost Control**: Direct lunar surface base construction avoids massive orbital construction and operational costs of Gateway
2. **Schedule Acceleration**: Simplified architecture focusing on lunar surface may accelerate overall Artemis program timeline
3. **Technology Focus**: Concentrating resources on lunar surface survival, resource utilization, and other key technologies

### Potential Challenges

1. **Technical Difficulty**: Extreme lunar environment (radiation, lunar dust, day-night temperature differentials) requires extremely high system reliability
2. **International Cooperation Complexity**: Abandoning Gateway may impact existing cooperation frameworks with partners such as ESA and JAXA
3. **Political Risk**: Strategic shift may trigger congressional and public scrutiny, requiring continuous justification of its rationale

## Sources (original pages)

- [NASA豪掷200亿美元建造月球基地,登月计划新调整 — Tencent News](https://new.qq.com/rain/a/20260327A01TZY00)
- [捍卫美国"太空霸主地位" NASA拟斥200亿美元建月球基地 — Sohu](https://so.html5.qq.com/page/real/search_news?docid=70000021_94069c91e9381852)
- [从月轨转向月表:深度解析NASA Artemis月球基地2026年三阶段新规划 — Sohu](https://www.sohu.com/a/1003694259_121124373)
