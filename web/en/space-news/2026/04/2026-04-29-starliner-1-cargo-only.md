...
title: "NASA and Boeing Modify Commercial Crew Contract: Starliner-1 Now Cargo-Only Mission"
description: "On April 29, 2026, NASA and Boeing formally modified the Starliner commercial crew contract, converting the first operational mission Starliner-1 from crewed to a cargo-only verification flight."
...
1. **Reduced operational mission count**: The original contract called for 6 crewed operational launches, now reduced to 4, with the remaining 2 as optional
2. **Starliner-1 converted to cargo-only**: The first operational mission will no longer carry astronauts, instead being converted to an uncrewed cargo verification flight to test propulsion system improvements
3. **Targeted launch window**: Starliner-1 is planned for April 2026 (no earlier than)
