...
keywords: Solar Synodic Period, observation, visibility, coverage
author: 天疆说
date: 2026-07-31
...
twitter:
  ...
  description: In the Earth-Moon rotating frame, the time for the Sun to complete one full cycle relative to the Earth-Moon line. The ratio T_sun/T_m is approximately 1.0809. 
  image: /logo.png
permalink: /en/glossary/observation/Tsun/
---
...
The time for the Sun to complete one full cycle relative to the Earth-Moon rotating frame; constraining resonant orbit periods to integer multiples of the solar synodic period locks optimal observation geometry.

## Related Concepts

- [Resonant Orbit](/en/glossary/orbits/共振轨道/)
- [Observation Geometry](/en/glossary/observation/观测几何/)
