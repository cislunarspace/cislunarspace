---
title: Deep Simple Online and Realtime Tracking (DeepSORT)
description: A multi-object tracking algorithm that extends SORT by incorporating appearance features from person re-identification. It fuses motion cues (Kalman filter...
keywords: Deep Simple Online and Realtime Tracking
...
wechatShare:
  ...
  image: /logo.png
og:
  title: Deep Simple Online and Realtime Tracking (DeepSORT) Explained | Term Definition
  description: A multi-object tracking algorithm that extends SORT by incorporating appearance features from person re-identification. It fuses motion cues (Kalman filter...
  image: /logo.png
  type: article
twitter:
  ...
  description: A multi-object tracking algorithm that extends SORT by incorporating appearance features from person re-identification. It fuses motion cues (Kalman filter...
  image: /logo.png
permalink: /en/glossary/observation/deep-simple-online-and-realtime-tracking/
---
