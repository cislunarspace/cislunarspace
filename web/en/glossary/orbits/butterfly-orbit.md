---
title: Butterfly Orbit
description: Detailed explanation of butterfly orbits — definitions, dynamical characteristics, large-amplitude periodic motion connecting L1 and L2 libration points, and applications in cislunar space missions
keywords: Butterfly Orbit, libration point, L1, L2, three-body problem, heteroclinic connection, orbital dynamics, cislunar space
...
wechatShare:
  ...
  image: /logo.png
og:
  title: Butterfly Orbit | Large-Amplitude Periodic Orbit Connecting L1 and L2
  description: Detailed explanation of butterfly orbits — definitions, dynamical characteristics, large-amplitude periodic motion connecting L1 and L2 libration points, and applications in cislunar space missions
  image: /logo.png
  type: article
twitter:
  ...
  description: Detailed explanation of butterfly orbits — definitions, dynamical characteristics, large-amplitude periodic motion connecting L1 and L2 libration points, and applications in cislunar space missions
  image: /logo.png
permalink: /en/glossary/orbits/butterfly-orbit/
---
...
- **Complex symmetry**: Butterfly orbits possess symmetry with respect to the $yOz$ plane, forming mirror-image structures on either side of the Earth-Moon line
