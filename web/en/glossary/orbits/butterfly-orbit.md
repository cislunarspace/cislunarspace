...
description: A three-dimensional periodic orbit family (P2HO1) born by period-doubling bifurcation from the NRHO segment of the halo family; its yz projection is a figure eight with two lobes on the Moon's L1 side and L2 side respectively; combined with halo orbits at a 2:1 period ratio it serves lunar south pole coverage, and its manifolds enable NRHO↔DRO transfers.
keywords: Butterfly Orbit, P2HO1, libration point orbit, periodic orbit, NRHO
...
wechatShare:
  ...
  image: /logo.png
og:
  title: "Butterfly Orbit Explained | Term Definition"
  description: A three-dimensional periodic orbit family (P2HO1) born by period-doubling bifurcation from the NRHO segment of the halo family; its yz projection is a figure eight with two lobes on the Moon's L1 side and L2 side respectively; combined with halo orbits at a 2:1 period ratio it serves lunar south pole coverage, and its manifolds enable NRHO↔DRO transfers.
  image: /logo.png
  type: article
twitter:
