...
description: Paired transfers associated with L1 and L2 orbits that are geometrically nearly symmetric.
keywords: Partner Transfer, cislunar space, orbital mechanics
...
wechatShare:
  ...
  image: /logo.png
og:
  title: "Partner Transfer Explained | Term Definition"
  description: Paired transfers associated with L1 and L2 orbits that are geometrically nearly symmetric.
  image: /logo.png
  type: article
twitter:
  ...
  description: Paired transfers associated with L1 and L2 orbits that are geometrically nearly symmetric.
  image: /logo.png
permalink: /en/glossary/orbits/partner-transfer/
---
...
Paired transfers associated with L1 and L2 orbits that are geometrically nearly symmetric.
