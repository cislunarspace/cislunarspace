...
- [Force Design](/en/glossary/doctrine/force-design/) — Provides the blueprint for the Objective Force
- [Force Generation](/en/glossary/doctrine/force-generation/) — Transforms development outputs into deployable forces
- [Force Employment](/en/glossary/doctrine/force-employment/) — Applies development outputs in actual operations
- [DOTMLPF-P Framework](/en/glossary/doctrine/dotmlpf-p/) — The dimensions Force Development must comprehensively cover
- [Mission Command](/en/glossary/doctrine/mission-command/) — A core capability that Force Development must cultivate
