---
title: Anti-Satellite Test (ASAT)
description: An anti-satellite test destroys an orbiting satellite via a ground-based missile direct-ascent co-planar collision, marking a major milestone in space militarization.
keywords: ASAT, anti-satellite test, anti-satellite weapon, India ASAT, Microsat-R, space militarization, kinetic intercept
...
wechatShare:
  ...
  image: /logo.png
og:
  title: Anti-Satellite Test (ASAT) Explained
  description: An anti-satellite test destroys an orbiting satellite via a ground-based missile direct-ascent co-planar collision.
  image: /logo.png
  type: article
twitter:
  ...
  description: An anti-satellite test destroys an orbiting satellite via a ground-based missile direct-ascent co-planar collision.
  image: /logo.png
permalink: /en/glossary/doctrine/asat/
---
...
- [Kinetic Weapon](/en/glossary/doctrine/kinetic-weapon/)
- [Directed Energy Weapon (DEW)](/en/glossary/doctrine/directed-energy-weapon/)
