...
- [Space Superiority](/en/glossary/doctrine/space-superiority/) — The ultimate objective of Force Employment
- [Force Design](/en/glossary/doctrine/force-design/) — Provides the capability foundation for Force Employment
- [Force Generation](/en/glossary/doctrine/force-generation/) — Provides deployable forces for Force Employment
- [Competitive Endurance](/en/glossary/doctrine/competitive-endurance/) — The strategic theory guiding Force Employment
- [Mission Command](/en/glossary/doctrine/mission-command/) — The command and control method for Force Employment
