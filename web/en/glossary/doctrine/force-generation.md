...
- [Force Design](/en/glossary/doctrine/force-design/) — Provides the Objective Force blueprint for Force Generation
- [Force Development](/en/glossary/doctrine/force-development/) — Provides trained personnel and systems for Force Generation
- [Force Employment](/en/glossary/doctrine/force-employment/) — Consumes Force Generation outputs to execute operational missions
- [Competitive Endurance](/en/glossary/doctrine/competitive-endurance/) — Guides the readiness requirements of Force Generation
- [Mission Command](/en/glossary/doctrine/mission-command/) — The command and control capability Force Generation must cultivate
