---
title: DOTMLPF-P Framework
description: DOTMLPF-P is a comprehensive U.S. military capability building framework covering Doctrine, Organization, Training, Materiel, Leader development, Personnel, Facilities, and Policy.
keywords: DOTMLPF-P, Doctrine, Organization, Training, Materiel, Leader development, Personnel, Facilities, Policy, capability building
...
1. **Comprehensiveness**: Capability building cannot focus on a single dimension (such as equipment acquisition) but must advance simultaneously across all eight dimensions.
2. **Purposefulness**: All building activities across every dimension must have the explicit objective of "contesting and controlling the space domain."
...
- [Space Superiority](/en/glossary/doctrine/space-superiority/) — The fundamental objective supported by the DOTMLPF-P framework
- [Competitive Endurance](/en/glossary/doctrine/competitive-endurance/) — The strategic theory guiding DOTMLPF-P building efforts
- [Force Design](/en/glossary/doctrine/force-design/) — Guides DOTMLPF-P building through concept development and requirements analysis
- [Force Development](/en/glossary/doctrine/force-development/) — Advances DOTMLPF-P dimensions through training, education, and talent management
