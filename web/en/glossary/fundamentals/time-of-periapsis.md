---
title: Time of Periapsis
description: The time when the spacecraft passes periapsis.
keywords: Time of Periapsis
...
wechatShare:
  ...
  image: /logo.png
og:
  title: "Time of Periapsis Explained | Term Definition"
  description: The time when the spacecraft passes periapsis.
  image: /logo.png
  type: article
twitter:
  ...
  description: The time when the spacecraft passes periapsis.
  image: /logo.png
permalink: /en/glossary/fundamentals/time-of-periapsis/
---
...
The time when the spacecraft passes periapsis.
