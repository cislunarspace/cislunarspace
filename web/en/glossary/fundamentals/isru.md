...
description: Detailed introduction to the definition, technical approaches, application scenarios, and strategic significance of In-Situ Resource Utilization (ISRU) in future space exploration
keywords: In-Situ Resource Utilization, ISRU, space mining, lunar resources, Mars resources, space exploration, Artemis
...
wechatShare:
  ...
  image: /logo.png
og:
  title: "In-Situ Resource Utilization (ISRU) | Terminology Definition"
  description: Detailed introduction to ISRU definition and technical approaches
  image: /logo.png
  type: article
twitter:
  ...
  description: Detailed introduction to ISRU definition and technical approaches
  image: /logo.png
permalink: /en/glossary/fundamentals/isru/
---
