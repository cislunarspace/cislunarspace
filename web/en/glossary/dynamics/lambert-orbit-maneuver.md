---
title: Lambert Orbit Maneuver
description: "An orbital maneuver method that uses Lambert's problem to solve for optimal transfer trajectory and required velocity increment from current orbit position to target position. In circumlunar rendezvous, transfer time can be flexibly adjusted to optimize velocity increment."
keywords: Lambert Orbit Maneuver, Lambert problem, velocity increment, circumlunar rendezvous, transfer time
