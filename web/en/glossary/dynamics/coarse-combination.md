---
title: Coarse Combination
description: The first step of trajectory patching, screening candidate patching points that satisfy position error and velocity impulse constraints.
keywords: Coarse Combination, cislunar space, orbital mechanics
...
wechatShare:
  ...
  image: /logo.png
og:
  title: Coarse Combination Explained | Term Definition
  description: The first step of trajectory patching, screening candidate patching points that satisfy position error and velocity impulse constraints.
  image: /logo.png
  type: article
twitter:
  ...
  description: The first step of trajectory patching, screening candidate patching points that satisfy position error and velocity impulse constraints.
  image: /logo.png
permalink: /en/glossary/dynamics/coarse-combination/
---
...
## Definition
The first step of trajectory patching, screening candidate patching points that satisfy position error and velocity impulse constraints.
