...
A dynamical system whose phase space volume contracts or expands with time. If the trace of the Jacobian is negative, volume contracts and the system tends toward an attractor.
