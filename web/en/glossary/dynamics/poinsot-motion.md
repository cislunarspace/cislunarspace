...
description: Geometric description of rigid body free motion about fixed point, based on inertia ellipsoid rolling on invariable plane.
keywords: Poinsot Motion, cislunar space, orbital mechanics, navigation, dynamics
...
wechatShare:
  ...
  image: /logo.png
og:
  title: Poinsot Motion Explained | Term Definition
  description: Geometric description of rigid body free motion about fixed point, based on inertia ellipsoid rolling on invariable plane.
  image: /logo.png
  type: article
twitter:
  ...
  description: Geometric description of rigid body free motion about fixed point, based on inertia ellipsoid rolling on invariable plane.
  image: /logo.png
permalink: /en/glossary/dynamics/poinsot-motion/
---
...
Geometric description of rigid body free motion about fixed point, based on inertia ellipsoid rolling on invariable plane.
