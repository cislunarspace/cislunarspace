---
title: Minimum Velocity Deviation Point
description: A nominal point selection criterion where the point on the nominal orbit minimizes the velocity deviation from the spacecraft.
keywords: Minimum Velocity Deviation Point
...
wechatShare:
  ...
  image: /logo.png
og:
  title: Minimum Velocity Deviation Point Explained | Term Definition
  description: A nominal point selection criterion where the point on the nominal orbit minimizes the velocity deviation from the spacecraft.
  image: /logo.png
  type: article
twitter:
  ...
  description: A nominal point selection criterion where the point on the nominal orbit minimizes the velocity deviation from the spacecraft.
  image: /logo.png
permalink: /en/glossary/dynamics/minimum-velocity-deviation-point/
---
...
A nominal point selection criterion where the point on the nominal orbit minimizes the velocity deviation from the spacecraft.
