...
keywords: Lunar Synodic Resonance, LSR, LSR, dynamics
...
twitter:
  ...
  description: A 9:2 monthly resonance where the Gateway NRHO orbital period forms a specific resonant relationship with the lunar synodic period, preventing Earth eclipses.
  image: /logo.png
permalink: /en/glossary/dynamics/lunar-synodic-resonance-lsr/
---

# Lunar Synodic Resonance, LSR (LSR)
...
该轨道类型可作为地月空间运输网络的中转站或任务的目标轨道。共振轨道可用于设计长期稳定的任务轨道，减少轨道维持代价。
