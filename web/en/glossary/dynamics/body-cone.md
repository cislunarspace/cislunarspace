---
title: Body Cone
description: Cone formed by instantaneous angular velocity vector rotating around spin axis in rigid body motion about fixed point.
keywords: Body Cone, cislunar space, orbital mechanics
...
wechatShare:
  ...
  image: /logo.png
og:
  title: Body Cone Explained | Term Definition
  description: Cone formed by instantaneous angular velocity vector rotating around spin axis in rigid body motion about fixed point.
  image: /logo.png
  type: article
twitter:
  ...
  description: Cone formed by instantaneous angular velocity vector rotating around spin axis in rigid body motion about fixed point.
  image: /logo.png
permalink: /en/glossary/dynamics/body-cone/
---
...
## Definition
Cone formed by instantaneous angular velocity vector rotating around spin axis in rigid body motion about fixed point.
