...
description: The maximum modulus of the eigenvalues of a matrix.
...
wechatShare:
  ...
  image: /logo.png
og:
  title: Spectral Radius Explained | Term Definition
  description: The maximum modulus of the eigenvalues of a matrix.
  image: /logo.png
  type: article
twitter:
  ...
  description: The maximum modulus of the eigenvalues of a matrix.
  image: /logo.png
permalink: /en/glossary/dynamics/spectral-radius/
---
...
The maximum modulus of the eigenvalues of a matrix.
