---
title: Shape Method
description: A preliminary design method for low-thrust trajectories. It uses analytical functions with undetermined parameters (shape functions) to approximate the geometry of transfer trajectories and derives co...
keywords: Shape Method
...
wechatShare:
  ...
  image: /logo.png
og:
  title: Shape Method Explained | Term Definition
  description: A preliminary design method for low-thrust trajectories. It uses analytical functions with undetermined parameters (shape functions) to approximate the geometry of transfer trajectories and derives co...
  image: /logo.png
  type: article
twitter:
  ...
  description: A preliminary design method for low-thrust trajectories. It uses analytical functions with undetermined parameters (shape functions) to approximate the geometry of transfer trajectories and derives co...
  image: /logo.png
permalink: /en/glossary/dynamics/shape-method/
---
# Shape Method
