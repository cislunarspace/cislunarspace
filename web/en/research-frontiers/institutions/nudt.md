---
permalink: /en/research-frontiers/institutions/nudt/
title: National University of Defense Technology
description: Overview of NUDT's strengths and representative research directions related to cislunar space.
keywords: National University of Defense Technology, NUDT, cislunar space, space security, orbital parameter characterization, low-energy transfer, Hamiltonian dynamics
author: CislunarSpace
date: 2026-03-07
lastUpdated: 2026-03-07
wechatShare:
  title: Research Institutions in Cislunar Space | National University of Defense Technology
...
**Abstract:** A four-pulse low-energy transfer orbit design method from EML1 Halo orbit to GEO, more efficient than the three-pulse model.
...
**Abstract:** A method for orbital parameter characterization of Earth-Moon collinear libration points using Hamiltonian dynamics and canonical transformations.

#### Orbital parameter characterization and objects cataloging for Earth-Moon collinear libration points

**Reference:** Qiao C, Long X, Yang L, et al. Orbital parameter characterization and objects cataloging for Earth-moon collinear libration points[J]. Chinese Journal of Aeronautics, 2025: 103869-103896.

**Abstract:** A novel approach to parameterize cislunar libration point orbits using canonical transformations, applicable to orbit identification and object cataloging.
