...
const glossaryCategoryNodes: TaxonomyNode[] = [
  ...
  },
  {
    ...
    kind: 'glossary-category',
    label: { zh: '动力学与数学基础', en: 'Dynamics & math' },
    path: { zh: null, en: null },
    order: 20020,
    parentId: GLOSSARY_ROOT_ID,
    meta: { slug: 'dynamics' },
  ...
  },
  {
    ...
    kind: 'glossary-category',
    label: { zh: '导航技术与系统', en: 'Navigation & systems' },
    path: { zh: null, en: null },
    order: 20040,
    parentId: GLOSSARY_ROOT_ID,
  ...
  {
    id: 'glossary/observation',
    kind: 'glossary-category',
    label: { zh: '天文观测技术', en: 'Astronomy & observation' },
    path: { zh: null, en: null },
    order: 20050,
    parentId: GLOSSARY_ROOT_ID,
    meta: { slug: 'observation' },
  },
  {
    id: 'glossary/doctrine',
    kind: 'glossary-category',
    label: { zh: '军事太空条令', en: 'Military space doctrine' },
    path: { zh: null, en: null },
    order: 20060,
    parentId: GLOSSARY_ROOT_ID,
    meta: { slug: 'doctrine' },
  },
  {
    ...
    kind: 'glossary-category',
    label: { zh: '机构和组织', en: 'Organizations' },
    path: { zh: null, en: null },
    order: 20070,
    parentId: GLOSSARY_ROOT_ID,
  ...
  },
  {
    ...
    kind: 'glossary-category',
    label: { zh: '其他技术', en: 'Other technologies' },
    path: { zh: null, en: null },
    order: 20080,
    parentId: GLOSSARY_ROOT_ID,
