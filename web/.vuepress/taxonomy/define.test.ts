...
): { id: string; kind: string; path: { zh: string | null; en: string | null } }[] {
...
describe('defineTaxonomy', () => {
  it('flattens a single section with children into section / group / page nodes', () => {
        ...
        children: [
          {
            ...
            children: [{ slug: 'l1', label: { zh: 'L1', en: 'L1' } }],
          },
        ],
      },
    ];
    ...
    expect(nodes[1].path).toEqual({
      zh: '/cislunar-orbits/nrho/',
      en: '/en/cislunar-orbits/nrho/',
    });
    expect(nodes[2].path).toEqual({
      zh: '/cislunar-orbits/nrho/l1/',
      en: '/en/cislunar-orbits/nrho/l1/',
    });
  });
        ...
        children: [
          {
            ...
            children: [{ slug: 'gmat', label: { zh: 'GMAT', en: 'GMAT' } }],
          },
        ],
      },
    ];
    ...
    const sections: SidebarSection[] = [
      {
        slug: 'resources-tools',
        label: { zh: '资源', en: 'Resources' },
        children: [{ label: { zh: '仿真软件', en: 'Simulation Software' }, children: [] }],
      },
    ];
  ...
  it('flattens flatNodes and sections into a single validated array', () => {
    ...
    const sections: SidebarSection[] = [{ slug: 'a', label: { zh: 'A', en: 'A' }, children: [] }];
