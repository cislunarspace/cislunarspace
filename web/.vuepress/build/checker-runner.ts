...
function printHelp<TArgs, TFindings>(config: CheckerConfig<TArgs, TFindings>, log: (msg: string) => void): void {
...
export function runChecker<TArgs, TFindings>(config: CheckerConfig<TArgs, TFindings>, deps: RunnerDeps = {}): void {
  const {
