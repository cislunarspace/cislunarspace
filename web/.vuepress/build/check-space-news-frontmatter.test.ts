...
describe('buildValidationResult', () => {
  it('produces correct summary with rule counts', () => {
    const issues: FrontmatterIssue[] = [
      { filePath: 'a.md', ruleId: 'missing-layout', severity: 'error', message: '', dimension: 'single-file' },
      { filePath: 'b.md', ruleId: 'missing-layout', severity: 'error', message: '', dimension: 'single-file' },
      { filePath: 'a.md', ruleId: 'missing-author', severity: 'warning', message: '', dimension: 'single-file' },
    ]
    ...
    expect(result.byRule).toContainEqual({ ruleId: 'missing-author', count: 1, severity: 'warning' })
  })
...
describe('formatTerminalOutput', () => {
  it('groups issues by dimension', () => {
    const issues: FrontmatterIssue[] = [
      { filePath: 'a.md', ruleId: 'missing-layout', severity: 'error', message: 'missing layout', dimension: 'single-file' },
      { filePath: 'b.md', ruleId: 'category-mismatch', severity: 'error', message: 'cat mismatch', dimension: 'cross-locale' },
    ]
    const result = buildValidationResult(issues)
...
describe('buildJsonReport', () => {
  it('includes all issues and summary', () => {
    const issues: FrontmatterIssue[] = [
      { filePath: 'a.md', ruleId: 'missing-layout', severity: 'error', message: '', field: 'layout', dimension: 'single-file' },
    ]
    const result = buildValidationResult(issues)
