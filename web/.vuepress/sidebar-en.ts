  ...
  children: [
    '/en/research-frontiers/',
    {
      ...
      children: [
        ...
        {
          text: 'Space Radiation Environment',
          link: '/en/research-frontiers/directions/radiation-environment/',
          collapsible: true,
          children: [],
        },
      ],
    ...
    children: [
      '/en/glossary/',
      {
        ...
        children: [
          ...
          '/en/glossary/dynamics/patched-method',
          '/en/glossary/dynamics/continuation',
          '/en/glossary/dynamics/differential-correction',
          '/en/glossary/dynamics/poincare-map',
          '/en/glossary/dynamics/impulsive-maneuver',
          '/en/glossary/dynamics/zero-velocity-surface',
          '/en/glossary/dynamics/hill-three-body',
          '/en/glossary/dynamics/bicircular-four-body',
          '/en/glossary/dynamics/quasi-bicircular-four-body',
          '/en/glossary/dynamics/strobe-map',
      ...
      },
      {
        ...
        collapsible: true,
        children: [
          '/en/glossary/orbits/dro',
          '/en/glossary/orbits/nrho',
          '/en/glossary/orbits/eml-halo',
          '/en/glossary/orbits/dro-constellation',
          '/en/glossary/orbits/orbit-identification',
          '/en/glossary/orbits/transfer-orbit',
          '/en/glossary/orbits/perilune',
          '/en/glossary/orbits/apolune',
          '/en/glossary/orbits/retrograde',
          '/en/glossary/orbits/prograde',
          '/en/glossary/orbits/parking-orbit',
          '/en/glossary/orbits/free-return-trajectory',
          '/en/glossary/orbits/halo-orbit',
          '/en/glossary/orbits/lissajous-orbit',
          '/en/glossary/orbits/lyapunov-orbit',
          '/en/glossary/orbits/cycler-trajectory',
          '/en/glossary/orbits/multi-revolution-halo',
      ...
      },
      {
        ...
        children: [
          ...
          '/en/glossary/navigation/liason-navigation',
        ],
      },
      {
        text: 'Lunar minerals',
      ...
      },
      {
        ...
        children: [
          ...
          '/en/glossary/other/cislunar-space',
          '/en/glossary/other/leo',
          '/en/glossary/other/lunar-gravity-assist',
          '/en/glossary/other/powered-lunar-flyby',
      ...
      {
        text: 'Military space doctrine',
        collapsible: true,
        children: [
          '/en/glossary/doctrine/space-superiority',
          '/en/glossary/doctrine/competitive-endurance',
          '/en/glossary/doctrine/dotmlpf-p',
          '/en/glossary/doctrine/mission-command',
          '/en/glossary/doctrine/force-design',
          '/en/glossary/doctrine/force-development',
          '/en/glossary/doctrine/force-generation',
          '/en/glossary/doctrine/force-employment',
          '/en/glossary/doctrine/spaforgen',
          '/en/glossary/doctrine/mission-delta',
          '/en/glossary/doctrine/system-delta',
          '/en/glossary/doctrine/space-mission-task-force',
          '/en/glossary/doctrine/comspacefor',
          '/en/glossary/doctrine/component-field-commands',
          '/en/glossary/doctrine/space-domain-awareness',
          '/en/glossary/doctrine/counterspace-operations',
          '/en/glossary/doctrine/resilient-architecture',
          '/en/glossary/doctrine/otti',
          '/en/glossary/doctrine/golden-dome',
        ],
      },
      {
        ...
        collapsible: true,
        children: [
          '/en/glossary/observation/image-stacking',
          '/en/glossary/observation/shift-and-add',
          '/en/glossary/observation/synthetic-tracking',
          '/en/glossary/observation/sidereal-tracking',
          '/en/glossary/observation/signal-to-noise-ratio',
          '/en/glossary/observation/astrometry',
          '/en/glossary/observation/source-extraction',
          '/en/glossary/observation/ephemeris-correlation',
          '/en/glossary/observation/cislunar-moving-objects',
          '/en/glossary/observation/lunar-glare-zone',
          '/en/glossary/observation/image-registration',
          '/en/glossary/observation/background-star-elimination',
          '/en/glossary/observation/segmentation-map',
          '/en/glossary/observation/hot-pixel',
        ],
      },
      {
        text: 'Satellite Communication & TT&C',
        collapsible: true,
        children: [
          '/en/glossary/communication/beidou-satellite-system',
          '/en/glossary/communication/inter-satellite-link',
          '/en/glossary/communication/all-time-seamless-communication',
          '/en/glossary/communication/constellation-networking',
          '/en/glossary/communication/microwave-link',
          '/en/glossary/communication/laser-microwave-communication',
        ],
      },
    ],
  },
