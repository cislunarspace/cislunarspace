...
export const sidebarSections: SidebarSection[] = [
  ...
  // ── 蓝军研究 ──
  {
    slug: 'blue-team-research',
    label: { zh: '蓝军研究', en: 'Blue-team research' },
    children: [],
    childrenByLocale: {
      zh: [
        {
          slug: 'doctrine-strategy',
          label: { zh: '作战条令研究', en: 'Doctrine & strategy' },
          collapsible: true,
          children: [
            { slug: '', label: { zh: '', en: '' } },
            { slug: 'us-doctrine-system', label: { zh: '美军条令体系', en: 'US doctrine system' } },
            { slug: 'joint-warfighting-doctrine', label: { zh: '联合作战条令', en: 'Joint warfighting doctrine' } },
            { slug: 'cyberspace-operations-doctrine', label: { zh: '网络空间作战条令', en: 'Cyberspace operations doctrine' } },
          ],
        },
        {
          slug: 'equipment-tech',
          label: { zh: '装备与技术发展', en: 'Equipment & technology' },
          collapsible: true,
          children: [
            { slug: '', label: { zh: '', en: '' } },
            { slug: 'sda-programs', label: { zh: 'SDA 项目', en: 'SDA programs' } },
            { slug: 'spacex-role', label: { zh: 'SpaceX 角色', en: 'SpaceX role' } },
            { slug: 'architecture-programs', label: { zh: '架构项目', en: 'Architecture programs' } },
            { slug: 'commercial-participation', label: { zh: '商业参与', en: 'Commercial participation' } },
          ],
        },
        {
          slug: 'operations-application',
          label: { zh: '作战应用与聚焦场景', en: 'Operations & scenarios' },
          collapsible: true,
          children: [
            { slug: '', label: { zh: '', en: '' } },
            { slug: 'regional-conflicts', label: { zh: '区域冲突', en: 'Regional conflicts' } },
            { slug: 'orbital-confrontation', label: { zh: '轨道对抗', en: 'Orbital confrontation' } },
            { slug: 'kill-chain-focus', label: { zh: '杀伤链聚焦', en: 'Kill chain focus' } },
            { slug: 'scenario-analysis', label: { zh: '场景分析', en: 'Scenario analysis' } },
            { slug: 'crosswalk', label: { zh: '交叉对照', en: 'Crosswalk' } },
          ],
        },
        {
          slug: 'knowledge-rag',
          label: { zh: '资料共享与知识库', en: 'Knowledge base & RAG' },
          collapsible: true,
          children: [
            { slug: '', label: { zh: '', en: '' } },
            { slug: 'search-metadata', label: { zh: '搜索元数据', en: 'Search metadata' } },
            { slug: 'rag-roadmap', label: { zh: 'RAG 路线图', en: 'RAG roadmap' } },
          ],
        },
      ],
      en: [
        {
          ...
          children: [
            { slug: '', label: { zh: '', en: '' } },
            { slug: 'us-strategy-doctrine', label: { zh: '美军战略条令', en: 'US strategy & doctrine' } },
            { slug: 'literature-index', label: { zh: '文献索引', en: 'Literature index' } },
            { slug: 'terminology', label: { zh: '术语表', en: 'Terminology' } },
          ],
        },
        {
          slug: 'equipment-tech',
