...
function sceneCtx(): SceneContext {
  return { Cesium: CesiumRef, viewer, orb, simElapsed, simTime, labels: { equator: ui.value.equator, peri: ui.value.peri, apo: ui.value.apo, sun: ui.value.sun }, locale: props.locale ?? 'zh' }
}
