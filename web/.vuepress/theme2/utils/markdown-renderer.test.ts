...
describe('renderInlineMarkdown', () => {
  ...
  it('renders bare https:// URLs as auto-links', () => {
    ...
    expect(html).toContain('<a href="https://example.com" class="chat-link">https://example.com</a>')
  })

  it('renders bare internal paths as auto-links', () => {
    const html = renderInlineMarkdown('see /en/glossary/cr3bp/', [])
    expect(html).toContain('<a href="/en/glossary/cr3bp/" class="chat-link">/en/glossary/cr3bp/</a>')
  })
