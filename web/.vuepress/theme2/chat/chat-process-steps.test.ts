...
import { beginStep, completeRunningSteps, completeStep, finalizeSteps } from './chat-process-steps';
...
describe('chat-process-steps', () => {
  ...
  describe('completeStep', () => {
    ...
    it('keeps existing detail when none is provided', () => {
      const start: ProcessStep[] = [{ label: 'label:stepNav', status: 'running', detail: 'paths' }];
