...
// ARCHIVED — 2026-07-05
//
// 一次性 TDD 验证脚本，服务于已完成的 issues #116–#119。
// 2026-03 Space News 图片引用修复已落地，2026-03 之外的内容已使脚本失效。
// 按架构审计 F-11（issue #194）从 scripts/ 顶层迁出，保留供历史溯源，**不要再次执行**。
//
// 归档依据：AGENTS.md §10 死代码 + 一次性资产归档惯例。
// =====================================================================
/**
